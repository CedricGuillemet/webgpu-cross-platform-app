import{S as e}from"./bjs-scene73.js";import"./bjs-scene73-backgroundUboDeclaration-COKUyJ2Z.js";const o="intersectionFunctions",i=`fn diskIntersectWithBackFaceCulling(ro: vec3f,rd: vec3f,c: vec3f,r: f32)->f32 {var d: f32=rd.y;if(d>0.0) { return 1e6; }
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=f);const a={name:r,shader:f};export{a as backgroundPixelShaderWGSL};