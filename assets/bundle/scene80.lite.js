    ...
    "../../../Babylon-Lite/packages/babylon-lite/src/material/node/blocks/gradient-block.ts"() {
      ...
      emitter66 = {
        ...
        emit(block, _outputName, stage, state, ctx) {
          ...
          const gradient2 = ctx.resolve(block, "gradient", stage, state);
          const g = gradient2.type === "f32" ? gradient2.expr : `((${gradient2.expr}).x)`;
    ...
    "../../../Babylon-Lite/packages/babylon-lite/src/material/node/blocks/replace-color-block.ts"() {
      ...
      emitter68 = {
        ...
        emit(block, _outputName, stage, state, ctx) {
          ...
          const reference2 = ctx.cast(ctx.resolve(block, "reference", stage, state), value.type).expr;
          const distance = ctx.cast(ctx.resolve(block, "distance", stage, state), "f32").expr;
          const replacement2 = ctx.cast(ctx.resolve(block, "replacement", stage, state), value.type).expr;
          return { expr: `select(${value.expr}, ${replacement2}, length(${value.expr} - ${reference2}) < ${distance})`, type: value.type };
        }
      };
    }
  });
...
`;
  ...
  // ../../../Babylon-Lite/lab/lite/src/shared/scene80-nme.ts
  var TARGET_VERTEX = 1;
  ...
  function colorConverter(name, inputKind, source, sourceOutput) {
    return addBlock(
      "ColorConverterBlock",
      name,
      TARGET_NEUTRAL,
      [input("rgb ", inputKind === "rgb" ? { id: source, output: sourceOutput } : void 0), input("hsl ", inputKind === "hsl" ? { id: source, output: sourceOutput } : void 0)],
  ...
  var gradient = addBlock("GradientBlock", "ColorRamp", TARGET_NEUTRAL, [input("gradient", { id: uvSplit, output: "x" })], [output("output")], {
    colorSteps: [
      { step: 0, color: { r: 0.02, g: 0.04, b: 0.42 } },
      { step: 0.28, color: { r: 0, g: 0.82, b: 0.95 } },
      { step: 0.58, color: { r: 1, g: 0.88, b: 0.08 } },
      { step: 1, color: { r: 0.95, g: 0.08, b: 0.62 } }
    ]
  });
  var rgbToHsl = colorConverter("RgbToHsl", "rgb", gradient, "output");
  var hslSplit = split("SplitHsl", rgbToHsl, "hsl", "xyz");
  var fiveSteps = inputBlock("fiveSteps", TYPE_FLOAT, 5);
  var posterHue = addBlock("PosterizeBlock", "PosterizeHue", TARGET_NEUTRAL, [input("value", { id: hslSplit, output: "x" }), input("steps", { id: fiveSteps, output: "output" })], [output("output")]);
  var mergedHsl = addBlock(
    "ColorMergerBlock",
    "MergePosterizedHsl",
    TARGET_NEUTRAL,
  ...
  var hslToRgb = colorConverter("HslToRgb", "hsl", mergedHsl, "rgb");
  var desaturate = addBlock("DesaturateBlock", "DesaturateByY", TARGET_NEUTRAL, [input("color", { id: hslToRgb, output: "rgb" }), input("level", { id: uvSplit, output: "y" })], [output("output")]);
  var reference = inputBlock("replaceReference", TYPE_COLOR3, [0.44, 0.44, 0.44]);
  var replacement = inputBlock("replaceHotPink", TYPE_COLOR3, [1, 0.04, 0.02]);
  var threshold = inputBlock("replaceDistance", TYPE_FLOAT, 0.18);
  var replace = addBlock(
    "ReplaceColorBlock",
    "ReplaceGreyBand",
    TARGET_NEUTRAL,
  ...
  var fragmentOutput = addBlock("FragmentOutputBlock", "FragmentOutput", TARGET_FRAGMENT, [input("rgba"), input("rgb", { id: finalColor, output: "rgb" }), input("a")], [], {
    convertToGammaSpace: false,
    convertToLinearSpace: false,
    useLogarithmicDepth: false
  });
  var SCENE80_NME_JSON = {
    tags: null,
    ignoreAlpha: false,
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene80.ts
  async function main() {
