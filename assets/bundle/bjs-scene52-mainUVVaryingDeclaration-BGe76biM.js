import{S as e}from"./bjs-scene52.js";const o="sceneUboDeclaration",r=`layout(std140,column_major) uniform;uniform Scene {mat4 viewProjection;
#ifdef MULTIVIEW
mat4 viewProjectionR;
#endif 
mat4 view;mat4 projection;vec4 vEyePosition;mat4 inverseProjection;};
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=r);const i="meshUboDeclaration",n=`#ifdef WEBGL2
...
#endif
#define WORLD_UBO
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=n);const t="defaultUboDeclaration",c=`layout(std140,column_major) uniform;uniform Material
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=c);const a="mainUVVaryingDeclaration",s=`#ifdef MAINUV{X}
