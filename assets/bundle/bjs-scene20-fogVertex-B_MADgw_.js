import{S as e}from"./bjs-scene20.js";const i="bonesDeclaration",c=`#if NUM_BONE_INFLUENCERS>0
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=N);const a="fogVertexDeclaration",I=`#ifdef FOG
...
#endif
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=u);const d="bonesVertex",S=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=S);const m="bakedVertexAnimation",x=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=x);const s="clipPlaneVertex",A=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=A);const o="fogVertex",T=`#ifdef FOG
