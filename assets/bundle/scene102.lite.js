...
${varyBody}
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene102.ts
  var PHYSICS_FPS = 60;
  var CAPTURE_DEFAULT_FRAME = 5;
  var COLLIDE_WITH = 2;
  var RAY_ORIGIN = { x: 0, y: 1, z: -2 };
  var RAY_DIR = { x: 0.1, y: 0, z: 1 };
  var RAY_LEN = 8;
  var RAY_DEST = { x: RAY_ORIGIN.x + RAY_DIR.x * RAY_LEN, y: RAY_ORIGIN.y + RAY_DIR.y * RAY_LEN, z: RAY_ORIGIN.z + RAY_DIR.z * RAY_LEN };
  ...
  function addFilteredMeshBox(engine, scene, world, z, color, membership) {
    ...
    const shape = createPhysicsShape(world, { type: 6 /* MESH */, mesh: box });
    setPhysicsShapeFilterMembershipMask(world, shape, membership);
    const body = createPhysicsBody(world, box, 0 /* STATIC */);
    setPhysicsBodyShape(world, body, shape);
  }
  async function main() {
    ...
    createPhysicsAggregate(world, ground, 3 /* BOX */, { mass: 0 });
