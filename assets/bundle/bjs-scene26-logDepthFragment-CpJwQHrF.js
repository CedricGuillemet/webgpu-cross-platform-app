import{c as e}from"./bjs-scene26.js";const t="lightFragmentDeclaration",c=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=v);const i="imageProcessingDeclaration",n=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=n);const a="imageProcessingFunctions",d=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=d);const r="shadowsFragmentFunctions",h=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=f);const l="logDepthFragment",p=`#ifdef LOGARITHMICDEPTH
