import{S as e}from"./bjs-scene171.js";import"./bjs-scene171-oitFragment-CFzG5zEM.js";import"./bjs-scene171-openpbrUboDeclaration-B8jy9ZuJ.js";import"./bjs-scene171-pbrDebug-rQWOPWPo.js";import"./bjs-scene171-imageProcessingFunctions-D5iEJi3p.js";import"./bjs-scene171-samplerFragmentDeclaration-C2DcjmOk.js";import"./bjs-scene171-pbrIBLFunctions-DOq1_yeY.js";import"./bjs-scene171-clipPlaneFragment-DRonNAME.js";import"./bjs-scene171-logDepthDeclaration-DEc80JOc.js";import"./bjs-scene171-fogFragment-qn-nAknN.js";import"./bjs-scene171-hdrFilteringFunctions-B1iMaVBu.js";import"./bjs-scene171-harmonicsFunctions-Bw-uX7Ah.js";import"./bjs-scene171-pbrBRDFFunctions-ExoLFnZl.js";import"./bjs-scene171-reflectionFunction-YYAorccq.js";import"./bjs-scene171-openpbrTransmissionLayerData-S2VlI9e1.js";import"./bjs-scene171-logDepthFragment-9H8mBh7R.js";import"./bjs-scene171-mainUVVaryingDeclaration-By9gBTy9.js";const a="openpbrFragmentSamplersDeclaration",h=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=h);const t="openpbrNormalMapFragmentMainFunctions",R=`#if defined(GEOMETRY_NORMAL) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=R);const i="openpbrNormalMapFragmentFunctions",N=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=N);const o="openpbrConductorReflectance",A=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=A);const n="openpbrAmbientOcclusionFunctions",T=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=T);const f="openpbrVolumeFunctions",b=`struct OpenPBRHomogeneousVolume {extinction_coeff: vec3f, 
ss_albedo: vec3f, 
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=b);const s="openpbrNormalMapFragment",L=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=L);const l="openpbrBlockNormalFinal",O=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=O);const c="openpbrBaseLayerData",F=`var base_color=vec3f(0.8);var base_metalness: f32=0.0;var base_diffuse_roughness: f32=0.0;var specular_weight: f32=1.0;var specular_roughness: f32=0.3;var specular_color: vec3f=vec3f(1.0);var specular_roughness_anisotropy: f32=0.0;var specular_ior: f32=1.5;var alpha: f32=1.0;var geometry_tangent: vec2f=vec2f(1.0,0.0);var geometry_thickness: f32=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=F);const _="openpbrCoatLayerData",C=`var coat_weight: f32=0.0f;var coat_color: vec3f=vec3f(1.0f);var coat_roughness: f32=0.0f;var coat_roughness_anisotropy: f32=0.0f;var coat_ior: f32=1.6f;var coat_darkening: f32=1.0f;var geometry_coat_tangent: vec2f=vec2f(1.0f,0.0f);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=C);const m="openpbrThinFilmLayerData",D=`#ifdef THIN_FILM
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=D);const d="openpbrFuzzLayerData",P=`var fuzz_weight: f32=0.0f;var fuzz_color: vec3f=vec3f(1.0f);var fuzz_roughness: f32=0.0f;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=P);const u="openpbrAmbientOcclusionData",x=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=x);const p="openpbrBackgroundTransmission",M=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=M);const g="openpbrEnvironmentLighting",G=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=G);const v="openpbrDirectLightingInit",y=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=y);const E="openpbrDirectLighting",z=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=z);const S="openpbrBlockPrePass",W=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=W);const r="openpbrPixelShader",I=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=I);const ae={name:r,shader:I};export{ae as openpbrPixelShaderWGSL};