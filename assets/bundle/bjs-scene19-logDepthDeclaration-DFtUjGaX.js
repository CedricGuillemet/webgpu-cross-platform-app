import{S as e}from"./bjs-scene19.js";const t="sceneUboDeclaration",l=`layout(std140,column_major) uniform;uniform Scene {mat4 viewProjection;
#ifdef MULTIVIEW
mat4 viewProjectionR;
#endif 
mat4 view;mat4 projection;vec4 vEyePosition;mat4 inverseProjection;};
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=l);const a="meshUboDeclaration",f=`#ifdef WEBGL2
...
#endif
#endif 
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=d);const i="harmonicsFunctions",m=`#ifdef USESPHERICALFROMREFLECTIONMAP
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=m);const c="logDepthDeclaration",h=`#ifdef LOGARITHMICDEPTH
