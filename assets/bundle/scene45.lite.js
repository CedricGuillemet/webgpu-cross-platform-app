...
${varyBody}
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene45.ts
  var PHYSICS_FPS = 60;
  var FILTER_GROUP_SPHERE = 1;
  var FILTER_GROUP_GROUND = 2;
  var FILTER_GROUP_BOX = 4;
  ...
  async function main() {
    ...
    const sphere1Aggregate = createPhysicsAggregate(world, sphere1, 0 /* SPHERE */, { mass: 1 });
    const sphere2Aggregate = createPhysicsAggregate(world, sphere2, 0 /* SPHERE */, { mass: 1 });
    const groundAggregate = createPhysicsAggregate(world, ground, 3 /* BOX */, { mass: 0 });
    const boxAggregate = createPhysicsAggregate(world, box, 3 /* BOX */, { mass: 0, extents: { x: 8, y: 2, z: 2 } });
