...
${makeBillboardFragmentWgsl(depthMode)}`;
  ...
  function addAxisLockedBillboardSystem(scene, system) {
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene56.ts
  var CAMERA_ALPHA = -Math.PI / 4;
  var CAMERA_BETA = 1.15;
  async function main() {
