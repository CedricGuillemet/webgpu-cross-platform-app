import{S as e}from"./bjs-scene12.js";const t="prePassDeclaration",u=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=u);const o="oitDeclaration",m=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=m);const a="decalFragmentDeclaration",S=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=S);const i="lightFragmentDeclaration",g=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=g);const r="lightUboDeclaration",D=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=D);const s="imageProcessingDeclaration",w=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=w);const l="fogFragmentDeclaration",E=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=E);const c="imageProcessingFunctions",C=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=C);const n="shadowsFragmentFunctions",x=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=T);const d="depthPrePass",F=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=F);const f="logDepthFragment",y=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=y);const h="fogFragment",P=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=P);const p="oitFragment",L=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=L);