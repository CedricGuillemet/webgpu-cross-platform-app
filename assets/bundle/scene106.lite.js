...
${varyBody}
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene106.ts
  var PHYSICS_FPS = 60;
  var PALETTE = [
    [0.85, 0.25, 0.25],
    // TELEPORT · STATIC
  ...
  var T_PER_STEP = 1e3 / PHYSICS_FPS / 300;
  ...
  async function main() {
    ...
    const motions = [0 /* STATIC */, 1 /* ANIMATED */, 2 /* DYNAMIC */];
    const presteps = [1 /* TELEPORT */, 2 /* ACTION */];
    const boxes = [];
    for (let prestep = 0; prestep < 2; prestep++) {
      for (let motion = 0; motion < 3; motion++) {
        ...
        createPhysicsAggregate(world, cylinder, 2 /* CYLINDER */, {
          mass: 1,
          restitution: 0.1,
          friction: 1,
          radius: 1,
        ...
        const boxAggregate = createPhysicsAggregate(world, box, 3 /* BOX */, {
          mass: motion,
          friction: 1,
