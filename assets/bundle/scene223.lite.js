...
(() => {
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/mesh/mesh-dispose.ts
...
${varyBody}
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/scene/scene-remove.ts
  init_mesh_scene_registry();
  init_mesh_dispose();
  init_render_task();
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/gizmo/camera-gizmo.ts
  init_scene_core();
  init_create_standard_material();
  var CAMERA_BODY_SCALE = 0.05;
  var FRUSTUM_EDGE_THICKNESS = 0.036;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/gizmo/light-gizmo.ts
  init_scene_core();
  init_create_standard_material();
  var LIGHT_GIZMO_SCALE = 7e-3;
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene223.ts
  async function main() {
