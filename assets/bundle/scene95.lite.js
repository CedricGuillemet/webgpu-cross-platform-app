...
${varyBody}
  ...
  function _registerBillboardFxHook(hook) {
...
@group(${group}) @binding(${binding}) var<uniform> fx: SpriteFx;`;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/sprite/billboard-custom-shader.ts
  init_scene_uniforms2();
  init_billboard_pipeline();
  init_sprite_fx_hook();
...
${fragment}
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene95.ts
  var CAMERA_ALPHA = -Math.PI / 3;
  async function main() {
