import{s as e}from"./bjs-scene159.js";const n="bonesDeclaration",c=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=c);const t="clipPlaneVertexDeclaration",u=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=u);const r="fogVertexDeclaration",l=`#ifdef FOG
varying vFogDistance: vec3f;
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=l);const f="bonesVertex",m=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=m);const s="clipPlaneVertex",E=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=E);const a="fogVertex",x=`#ifdef FOG
#ifdef SCENE_UBO
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=x);const d="vertexColorMixing",v=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=v);const i="colorVertexShader",o=`attribute position: vec3f;
#ifdef VERTEXCOLOR
...
}`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=o);const p={name:i,shader:o};export{p as colorVertexShaderWGSL};