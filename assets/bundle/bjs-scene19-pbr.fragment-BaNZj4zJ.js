import{S as e}from"./bjs-scene19.js";import"./bjs-scene19-logDepthDeclaration-DFtUjGaX.js";import"./bjs-scene19-fogFragment-BP1ASjsg.js";import"./bjs-scene19-helperFunctions-DIxBm6jA.js";const t="prePassDeclaration",re=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=re);const o="oitDeclaration",fe=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=ce);const r="pbrFragmentExtraDeclaration",se=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=se);const f="lightFragmentDeclaration",de=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=de);const l="lightUboDeclaration",ue=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=ue);const c="samplerFragmentDeclaration",Ee=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=Ee);const s="samplerFragmentAlternateDeclaration",ve=`#ifdef _DEFINENAME_
#if _DEFINENAME_DIRECTUV==1
#define v_VARYINGNAME_UV vMainUV1
#elif _DEFINENAME_DIRECTUV==2
#define v_VARYINGNAME_UV vMainUV2
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=ve);const d="pbrFragmentReflectionDeclaration",he=`#ifdef REFLECTION
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=he);const u="pbrFragmentSamplersDeclaration",me=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=me);const E="imageProcessingDeclaration",Se=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=Se);const v="subSurfaceScatteringFunctions",pe=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=pe);const h="importanceSampling",Ce=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=Ce);const m="pbrHelperFunctions",Re=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=Re);const S="imageProcessingFunctions",ge=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=ge);const p="shadowsFragmentFunctions",Ae=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=Ie);const R="pbrDirectLightingSetupFunctions",Te=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=Te);const g="pbrDirectLightingFalloffFunctions",Le=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=Le);const A="hdrFilteringFunctions",De=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
#endif
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=De);const I="pbrDirectLightingFunctions",Ne=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=Ne);const T="pbrIBLFunctions",Oe=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=Oe);const L="bumpFragmentMainFunctions",_e=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=_e);const D="bumpFragmentFunctions",Me=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=Me);const N="reflectionFunction",Fe=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=Fe);const O="decalFragment",Pe=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=Pe);const _="pbrBlockAlbedoOpacity",Ue=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=Ue);const M="pbrBlockReflectivity",be=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=be);const F="pbrBlockAmbientOcclusion",xe=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=xe);const P="pbrBlockAlphaFresnel",ye=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=ye);const U="pbrBlockAnisotropic",we=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=we);const b="pbrBlockReflection",Xe=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=Xe);const x="pbrBlockSheen",Be=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=Be);const y="pbrBlockClearcoat",Ge=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=Ge);const w="pbrBlockIridescence",He=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=He);const X="pbrBlockSubSurface",Ve=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=Ve);const B="clusteredLightingFunctions",We=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=We);const G="pbrBlockReflectance0",ze=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=ze);const H="pbrClusteredLightingFunctions",ke=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=ke);const V="pbrBlockNormalGeometric",Ye=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=Ye);const W="bumpFragment",$e=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=$e);const z="pbrBlockNormalFinal",Ke=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=Ke);const k="depthPrePass",qe=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=qe);const Y="pbrBlockLightmapInit",Ze=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=Ze);const $="pbrBlockGeometryInfo",je=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[$]||(e.IncludesShadersStore[$]=je);const K="pbrBlockReflectance",Qe=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=Qe);const q="pbrBlockDirectLighting",Je=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[q]||(e.IncludesShadersStore[q]=Je);const Z="lightFragment",ei=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[Z]||(e.IncludesShadersStore[Z]=ei);const j="pbrBlockFinalLitComponents",ii=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=ii);const Q="pbrBlockFinalUnlitComponents",ti=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[Q]||(e.IncludesShadersStore[Q]=ti);const J="pbrBlockFinalColorComposition",oi=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=oi);const ee="logDepthFragment",ai=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[ee]||(e.IncludesShadersStore[ee]=ai);const ie="pbrBlockImageProcessing",ni=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[ie]||(e.IncludesShadersStore[ie]=ni);const te="pbrBlockPrePass",ri=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[te]||(e.IncludesShadersStore[te]=ri);const oe="oitFragment",fi=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[oe]||(e.IncludesShadersStore[oe]=fi);const ae="pbrDebug",li=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[ae]||(e.IncludesShadersStore[ae]=li);const i="pbrPixelShader",ne=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=ne);const Ei={name:i,shader:ne};export{Ei as pbrPixelShader};