import{S as e}from"./bjs-scene22.js";import"./bjs-scene22-oitFragment-QdxrLLOV.js";import"./bjs-scene22-harmonicsFunctions-IuOK-CLN.js";import"./bjs-scene22-logDepthDeclaration-DL3_rXpQ.js";import"./bjs-scene22-fogFragment-DElHvSeR.js";import"./bjs-scene22-helperFunctions-4z8Hi9CW.js";import"./bjs-scene22-meshUboDeclaration-D_83-Mme.js";const n="pbrFragmentDeclaration",x=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=ee);const A="pbrBlockAmbientOcclusion",ie=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=ie);const m="pbrBlockAlphaFresnel",ne=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=ne);const I="pbrBlockAnisotropic",ae=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=Se);const U="pbrBlockFinalLitComponents",Ae=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=Ae);const b="pbrBlockFinalUnlitComponents",me=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=me);const B="pbrBlockFinalColorComposition",Ie=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=H);const Me={name:i,shader:H};export{Me as pbrPixelShader};