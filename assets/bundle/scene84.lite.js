...
`;
  ...
  // ../../../Babylon-Lite/lab/lite/src/shared/scene84-nme.ts
  var TARGET_VERTEX = 1;
  ...
  function divide(name, left, leftOutput, right, rightOutput) {
  ...
  function split(name, source, sourceOutput) {
  ...
  var wvpVertex = inputBlock("worldViewProjection", TYPE_MATRIX, null, 0, 6, TARGET_VERTEX);
  var wvpFragment = inputBlock("worldViewProjection", TYPE_MATRIX, null, 0, 6, TARGET_FRAGMENT);
  var clipPos = transform("TransformWVP", position, wvpVertex, 1);
  var vertexOutput = addBlock("VertexOutputBlock", "VertexOutput", TARGET_VERTEX, [input("vector", { id: clipPos, output: "output" })], []);
  var fragCoord = addBlock("FragCoordBlock", "FragCoord", TARGET_FRAGMENT, [], [output("xy"), output("xyz"), output("xyzw"), output("x"), output("y"), output("z"), output("w")]);
  var screenSize = addBlock("ScreenSizeBlock", "ScreenSize", TARGET_FRAGMENT, [], [output("xy"), output("x"), output("y")]);
  var screenUv = divide("ScreenUV", fragCoord, "xy", screenSize, "xy");
  var screenUvSplit = split("SplitScreenUV", screenUv, "output");
  var twirlStrength = inputBlock("twirlStrength", TYPE_FLOAT, 8.5);
  var twirlCenter = inputBlock("twirlCenter", TYPE_VECTOR2, [0.5, 0.5]);
  var twirlOffset = inputBlock("twirlOffset", TYPE_VECTOR2, [0, 0]);
  var twirl = addBlock(
    "TwirlBlock",
    "Twirl",
    TARGET_FRAGMENT,
  ...
  var rgb = color("FragmentColor", twirl, "x", screenSpace, "y", fragCoord, "z");
  ...
  var fragDepth = addBlock("FragDepthBlock", "FragDepth", TARGET_FRAGMENT, [input("depth", { id: screenUvSplit, output: "x" }), input("worldPos"), input("viewProjection")], []);
  var SCENE84_NME_JSON = {
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene84.ts
  async function main() {
