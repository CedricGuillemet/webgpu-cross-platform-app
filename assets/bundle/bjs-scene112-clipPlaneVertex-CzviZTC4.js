import{S as e}from"./bjs-scene112.js";const i="bonesDeclaration",f=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=f);const n="clipPlaneVertexDeclaration",s=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=s);const t="bonesVertex",a=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
