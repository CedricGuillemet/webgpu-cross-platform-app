...
${varyBody}
  ...
  function setBillboardShaderParams(system, params) {
    const target = system.shaderParams ?? (system.shaderParams = [0, 0, 0, 0]);
    target[0] = params[0];
    target[1] = params[1];
    target[2] = params[2];
    target[3] = params[3];
...
${fragment}
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene94.ts
  var CAMERA_ALPHA = -Math.PI / 3;
  var SCENE94_PARAMS = [1, 0.78, 0.55, 1];
  async function main() {
