import{S as e}from"./bjs-scene171.js";import"./bjs-scene171-openpbrUboDeclaration-B8jy9ZuJ.js";import"./bjs-scene171-samplerVertexImplementation-BdzPcrtJ.js";import"./bjs-scene171-mainUVVaryingDeclaration-By9gBTy9.js";import"./bjs-scene171-pbrBRDFFunctions-ExoLFnZl.js";import"./bjs-scene171-clipPlaneVertex-BmNgYyxZ.js";import"./bjs-scene171-harmonicsFunctions-Bw-uX7Ah.js";import"./bjs-scene171-fogVertexDeclaration-DYjad_vD.js";import"./bjs-scene171-shadowsVertex-C289JxqC.js";import"./bjs-scene171-morphTargetsVertex-DYh-sp9z.js";import"./bjs-scene171-logDepthDeclaration-DEc80JOc.js";import"./bjs-scene171-fogVertex-rmvULO4d.js";import"./bjs-scene171-vertexColorMixing-QS_l8wby.js";import"./bjs-scene171-logDepthVertex-BUYRTW3i.js";const i="openpbrNormalMapVertexDeclaration",E=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL) 
varying vTBN0: vec3f;varying vTBN1: vec3f;varying vTBN2: vec3f;
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=E);const t="openpbrNormalMapVertex",a=`#if defined(GEOMETRY_NORMAL) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(FUZZ)
#if defined(TANGENT) && defined(NORMAL)
var tbnNormal: vec3f=normalize(normalUpdated);var tbnTangent: vec3f=normalize(tangentUpdated.xyz);var tbnBitangent: vec3f=cross(tbnNormal,tbnTangent)*tangentUpdated.w;var matTemp= mat3x3f(finalWorld[0].xyz,finalWorld[1].xyz,finalWorld[2].xyz)* mat3x3f(tbnTangent,tbnBitangent,tbnNormal);vertexOutputs.vTBN0=matTemp[0];vertexOutputs.vTBN1=matTemp[1];vertexOutputs.vTBN2=matTemp[2];
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=a);const n="openpbrVertexShader",r=`#define OPENPBR_VERTEX_SHADER
...
}`;e.ShadersStoreWGSL[n]||(e.ShadersStoreWGSL[n]=r);const p={name:n,shader:r};export{p as openpbrVertexShaderWGSL};