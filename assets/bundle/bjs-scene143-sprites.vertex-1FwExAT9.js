import{S as t}from"./bjs-scene143.js";const e="spritesVertexShader",r=`attribute position: vec4f;attribute options: vec2f;attribute offsets: vec2f;attribute inverts: vec2f;attribute cellInfo: vec4f;attribute color: vec4f;uniform view: mat4x4f;uniform projection: mat4x4f;varying vUV: vec2f;varying vColor: vec4f;
...
}`;t.ShadersStoreWGSL[e]||(t.ShadersStoreWGSL[e]=r);const v={name:e,shader:r};export{v as spritesVertexShaderWGSL};