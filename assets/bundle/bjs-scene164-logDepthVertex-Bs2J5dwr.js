import{S as e}from"./bjs-scene164.js";const t="uvAttributeDeclaration",_=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
attribute uv{X}: vec2f;
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=_);const i="prePassVertexDeclaration",x=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=x);const f="samplerVertexDeclaration",m=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying v_VARYINGNAME_UV: vec2f;
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=m);const r="fogVertexDeclaration",E=`#ifdef FOG
varying vFogDistance: vec3f;
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=E);const a="lightVxUboDeclaration",V=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=V);const n="vertexPullingDeclaration",I=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=I);const d="vertexPullingVertex",y=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=y);const o="prePassVertex",S=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=S);const s="uvVariableDeclaration",O=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=O);const u="samplerVertexImplementation",T=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=T);const v="fogVertex",h=`#ifdef FOG
#ifdef SCENE_UBO
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=h);const l="shadowsVertex",U=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=U);const p="vertexColorMixing",g=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=g);const c="logDepthVertex",N=`#ifdef LOGARITHMICDEPTH
