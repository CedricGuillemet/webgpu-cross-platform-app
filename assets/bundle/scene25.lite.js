...
@fragment fn fs(v:V)->@location(0)vec4f{return textureSample(t,s,v.u);}`;
  ...
  function suffixToFeature(suffix) {
...
${varyBody}
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/texture/ktx-loader.ts
  init_typed_arrays();
  init_gpu_flags();
  init_gpu_pool();
  init_texture_2d();
  init_compressed_formats();
  var KTX_MAGIC = new U8([171, 75, 84, 88, 32, 49, 49, 187, 13, 10, 26, 10]);
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene25.ts
  async function main() {
