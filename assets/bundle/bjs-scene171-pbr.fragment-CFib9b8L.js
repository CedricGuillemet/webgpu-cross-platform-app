...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=M);const a="samplerFragmentAlternateDeclaration",D=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=D);const r="pbrFragmentSamplersDeclaration",h=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=h);const f="pbrBlockAlbedoOpacity",F=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=F);const o="pbrBlockReflectivity",g=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=g);const t="pbrBlockAmbientOcclusion",P=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=P);const c="pbrBlockAlphaFresnel",U=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=U);const l="pbrBlockAnisotropic",b=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=b);const d="pbrBlockReflection",y=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=y);const s="pbrBlockSheen",B=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=B);const E="pbrBlockClearcoat",G=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=G);const R="pbrBlockIridescence",V=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=V);const C="pbrBlockSubSurface",H=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=H);const S="pbrBlockReflectance0",x=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=x);const u="pbrClusteredLightingFunctions",W=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=W);const A="pbrBlockNormalFinal",Y=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=Y);const I="pbrBlockLightmapInit",X=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=X);const m="pbrBlockGeometryInfo",k=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=k);const v="pbrBlockReflectance",w=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=w);const N="pbrBlockDirectLighting",K=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=K);const T="pbrBlockFinalLitComponents",z=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=z);const O="pbrBlockFinalUnlitComponents",$=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=$);const p="pbrBlockFinalColorComposition",Z=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=Z);const L="pbrBlockPrePass",q=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=q);const i="pbrPixelShader",_=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=_);const Ae={name:i,shader:_};export{Ae as pbrPixelShader};