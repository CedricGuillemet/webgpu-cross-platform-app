...
${wrapper.options.fragmentWGSL}`
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene74.ts
  var FRAGMENT_WGSL = `fn crispLine(value:f32,width:f32)->f32{return 1.0-smoothstep(width,width+0.004,abs(fract(value)-0.5));}
