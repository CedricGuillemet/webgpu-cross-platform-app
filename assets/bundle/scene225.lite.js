...
${varyBody}
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/camera/geospatial-camera.ts
  init_world_matrix_state();
  init_matrix_allocator();
  init_mat4_look_at_lh();

  // ../../../Babylon-Lite/packages/babylon-lite/src/camera/geospatial-limits.ts
  var GEO_EPSILON = 1e-3;
  ...
  var WORLD_NORTH = { x: 0, y: 0, z: 1 };
  var WORLD_RIGHT = { x: 1, y: 0, z: 0 };
  var POLE_SINE_LIMIT = 0.998749218;
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene225.ts
  var PLANET_RADIUS = 100;
  var CAMERA_RADIUS = 170;
  var CAMERA_YAW = 0.6;
  var CAMERA_PITCH = 0.85;
  var CENTER_LAT = 20;
  var CENTER_LON = 30;
  var MARKER_SIZE = 18;
  var MARKERS = [
