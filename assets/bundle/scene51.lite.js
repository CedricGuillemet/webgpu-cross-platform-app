...
@fragment fn fs(v:V)->@location(0)vec4f{return textureSample(t,s,v.u);}`;
  ...
  var _ALPHA_BLEND_STATE, _PREMULTIPLIED_BLEND_STATE;
...
return out;
  ...
  // ../../../Babylon-Lite/lab/lite/src/_shared/sprite-atlas-soft.ts
  var ATLAS_WIDTH = 256;
  var ATLAS_HEIGHT = 128;
  var CELL = 32;
  var _cachedStraight = null;
  var SOFT_SPRITE_ATLAS_INFO = {
    widthPx: ATLAS_WIDTH,
  ...
  function drawSoftCell(ctx, x, y, idx) {
    const cx = x + CELL / 2;
    const cy = y + CELL / 2;
  ...
  function getSoftSpriteAtlasDataUrl() {
    if (_cachedStraight) {
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene51.ts
  async function main() {
