import{S as e}from"./bjs-scene20.js";const t="lightFragmentDeclaration",f=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=f);const o="lightUboDeclaration",h=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=h);const i="imageProcessingDeclaration",v=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=v);const r="imageProcessingFunctions",u=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=u);const a="shadowsFragmentFunctions",p=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=S);const n="reflectionFunction",m=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=m);const l="clusteredLightingFunctions",g=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=g);const d="lightFragment",w=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=w);const c="logDepthFragment",X=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=X);