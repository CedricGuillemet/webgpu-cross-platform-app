...
${varyBody}
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/physics/havok-collision.ts
  init_havok();
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene100.ts
  var PHYSICS_FPS = 60;
  ...
  async function main() {
    ...
    const sphereAggregate = createPhysicsAggregate(world, sphere, 0 /* SPHERE */, {
      mass: 1,
      restitution: 0.75
    });
