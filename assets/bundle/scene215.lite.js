...
`;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/mesh/create-torus-knot.ts
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/shadow/csm-directional-shadow-generator.ts
  init_gpu_buffers();

  // ../../../Babylon-Lite/packages/babylon-lite/src/shadow/csm-shadow-task-hooks.ts
  init_render_task();
  init_camera();
  init_mat4_invert();
  var preloadCsmShadowTaskState = preloadPcfShadowTaskState;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/shader/fragments/csm-shadow-fragment-core.ts
  var STAGE_FRAGMENT11 = 2;
  function createCsmShadowFragment(id, shadowLights, opts = {}) {
    ...
    for (const slot of shadowLights) {
      ...
      const suffix = `_${li}`;
      bindings.push(
        { _name: `csmTex${suffix}`, _type: { _kind: "texture", _textureType: "texture_depth_2d_array", _sampleType: "depth" }, _group: "shadow", _visibility: STAGE_FRAGMENT11 },
        { _name: `csmComp${suffix}`, _type: { _kind: "sampler", _samplerType: "sampler_comparison" }, _group: "shadow", _visibility: STAGE_FRAGMENT11 },
        { _name: `csmInfo${suffix}`, _type: { _kind: "uniform-buffer" }, _group: "shadow", _visibility: STAGE_FRAGMENT11 }
      );
      helperParts.push(
...
return shadow;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/material/standard/fragments/std-csm-shadow-fragment.ts
  function createStdCsmShadowFragment(shadowLights) {
    return createCsmShadowFragment("std-csm-shadow", shadowLights);
  }

  // ../../../Babylon-Lite/packages/babylon-lite/src/material/pbr/fragments/pbr-csm-shadow-fragment.ts
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene215.ts
  var SCENE_SIZE = 2e3;
  var NUM_CASTERS = 200;
  var PRNG_SEED = 1337;
