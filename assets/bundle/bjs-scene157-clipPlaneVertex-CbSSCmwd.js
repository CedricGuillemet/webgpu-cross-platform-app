import{S as e}from"./bjs-scene157.js";const t="bonesDeclaration",E=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=E);const r="bakedVertexAnimationDeclaration",I=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=I);const i="instancesDeclaration",x=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=x);const n="clipPlaneVertexDeclaration",u=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=u);const a="morphTargetsVertexGlobalDeclaration",S=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=S);const f="morphTargetsVertexDeclaration",N=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=N);const d="morphTargetsVertexGlobal",A=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=A);const o="morphTargetsVertex",R=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=R);const m="instancesVertex",p=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=p);const s="bonesVertex",v=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=v);const c="bakedVertexAnimation",V=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=V);const l="bumpVertex",h=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
vec3 tbnNormal=normalize(normalUpdated);vec3 tbnTangent=normalize(tangentUpdated.xyz);vec3 tbnBitangent=cross(tbnNormal,tbnTangent)*tangentUpdated.w;vTBN=mat3(finalWorld)*mat3(tbnTangent,tbnBitangent,tbnNormal);
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=h);const T="clipPlaneVertex",_=`#ifdef CLIPPLANE
