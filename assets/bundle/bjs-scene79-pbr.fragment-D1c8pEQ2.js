import{S as e}from"./bjs-scene79.js";import"./bjs-scene79-harmonicsFunctions-Cujt_bYy.js";const n="prePassDeclaration",z=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=z);const a="oitDeclaration",K=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=q);const r="pbrFragmentExtraDeclaration",Z=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=Z);const f="samplerFragmentAlternateDeclaration",j=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=j);const c="pbrFragmentReflectionDeclaration",J=`#ifdef REFLECTION
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=J);const l="pbrFragmentSamplersDeclaration",Q=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=Q);const d="subSurfaceScatteringFunctions",ee=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=ee);const s="importanceSampling",ie=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=ie);const E="pbrHelperFunctions",ne=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=ne);const R="pbrDirectLightingSetupFunctions",ae=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=ae);const u="pbrDirectLightingFalloffFunctions",te=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=te);const C="hdrFilteringFunctions",oe=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=oe);const S="pbrDirectLightingFunctions",re=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=re);const A="pbrIBLFunctions",fe=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=fe);const m="decalFragment",ce=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=ce);const I="pbrBlockAlbedoOpacity",le=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=le);const v="pbrBlockReflectivity",de=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=de);const N="pbrBlockAmbientOcclusion",se=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=se);const T="pbrBlockAlphaFresnel",Ee=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=Ee);const p="pbrBlockAnisotropic",Re=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=Re);const O="pbrBlockReflection",ue=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=ue);const g="pbrBlockSheen",Ce=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=Ce);const L="pbrBlockClearcoat",Se=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=Se);const h="pbrBlockIridescence",Ae=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=Ae);const _="pbrBlockSubSurface",me=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=me);const D="pbrBlockReflectance0",Ie=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=Ie);const M="pbrClusteredLightingFunctions",ve=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=ve);const F="pbrBlockNormalGeometric",Ne=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=Ne);const P="pbrBlockNormalFinal",Te=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=Te);const U="depthPrePass",pe=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=pe);const b="pbrBlockLightmapInit",Oe=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=Oe);const B="pbrBlockGeometryInfo",ge=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=ge);const y="pbrBlockReflectance",Le=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=Le);const G="pbrBlockDirectLighting",he=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=he);const V="pbrBlockFinalLitComponents",_e=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=_e);const H="pbrBlockFinalUnlitComponents",De=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=De);const x="pbrBlockFinalColorComposition",Me=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=Me);const W="pbrBlockImageProcessing",Fe=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=Fe);const X="pbrBlockPrePass",Pe=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=Pe);const Y="oitFragment",Ue=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=Ue);const k="pbrDebug",be=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=be);const i="pbrPixelShader",w=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=w);const Ge={name:i,shader:w};export{Ge as pbrPixelShader};