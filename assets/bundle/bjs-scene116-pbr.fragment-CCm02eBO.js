...
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=fe);const L="pbrBlockSubSurface",ce=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=ce);const p="pbrBlockReflectance0",le=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=le);const g="pbrClusteredLightingFunctions",de=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=H);const De={name:i,shader:H};export{De as pbrPixelShader};