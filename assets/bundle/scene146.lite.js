...
alpha *= input.vInstanceColor.a;`
  ...
  var WGSL_PERTURB_NORMAL, WGSL_FOG, WGSL_DITHER, WGSL_NO_DITHER;
...
${fragment}`, label: `copy-to-texture-${moduleKey}` });
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene146.ts
  var SPONZA_URL = "https://raw.githubusercontent.com/KhronosGroup/glTF-Sample-Assets/main/Models/Sponza/glTF/Sponza.gltf";
  async function main() {
