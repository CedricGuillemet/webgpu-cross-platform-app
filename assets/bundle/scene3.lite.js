...
${varyBody}
  ...
  function buildSkyboxCubeMapGPU(engine, worldMatrix, cubeView, cubeSampler) {
    ...
    const vertModule = device.createShaderModule({ code: SCENE_UBO_WGSL + skybox_cubemap_vertex_default, label: "skybox-cm-vert" });
    const fragModule = device.createShaderModule({ code: SCENE_UBO_WGSL + WGSL_FOG + skybox_cubemap_fragment_default, label: "skybox-cm-frag" });
    const gpu = {
  ...
  var init_skybox_cubemap = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/material/standard/skybox-cubemap.ts"() {
      "use strict";
      init_gpu_flags();
      init_skybox_cubemap_vertex();
      init_skybox_cubemap_fragment();
      init_scene_helpers();
      init_wgsl_helpers();
      init_scene_uniforms2();
      init_gpu_buffers();
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/loader-skybox/skybox-renderable.ts
  var skybox_renderable_exports = {};
  __export(skybox_renderable_exports, {
    buildSkyboxRenderable: () => buildSkyboxRenderable
  });
  ...
  var init_skybox_renderable = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/loader-skybox/skybox-renderable.ts"() {
      "use strict";
      init_skybox_cubemap();
    }
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/loader-skybox/load-skybox.ts
  init_typed_arrays();
  init_gpu_flags();
  init_cube_texture();
  init_gpu_buffers();
  async function loadSkybox(scene, baseUrl, ext, size = 100) {
    ...
    const { buildSkyboxRenderable: buildSkyboxRenderable2 } = await Promise.resolve().then(() => (init_skybox_renderable(), skybox_renderable_exports));
    scene._renderables.push(buildSkyboxRenderable2(scene, skyboxData));
  }

  // ../../../Babylon-Lite/lab/lite/src/lite/scene3.ts
  async function main() {
