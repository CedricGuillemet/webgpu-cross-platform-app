import{S as e}from"./bjs-scene112.js";const t="lightFragmentDeclaration",c=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=c);const o="lightUboDeclaration",v=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=n);const a="shadowsFragmentFunctions",d=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=d);const r="imageProcessingDeclaration",h=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=h);const s="imageProcessingFunctions",f=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=f);const l="logDepthFragment",p=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=p);