import{S as e}from"./bjs-scene171.js";import"./bjs-scene171-oitFragment-BtH9qRHP.js";import"./bjs-scene171-openpbrMaterial-_oTr3-4T.js";import"./bjs-scene171-openpbrUboDeclaration-D6gHqDEo.js";import"./bjs-scene171-pbrDebug-8FWk0ug-.js";import"./bjs-scene171-imageProcessingFunctions-Co4xI5HC.js";import"./bjs-scene171-bumpFragment-CSsAlY5y.js";import"./bjs-scene171-pbrIBLFunctions-BTJ5zDBA.js";import"./bjs-scene171-clipPlaneFragment-DiL17o4B.js";import"./bjs-scene171-logDepthDeclaration-phzi0NoR.js";import"./bjs-scene171-fogFragment-D6HY96iL.js";import"./bjs-scene171-helperFunctions-B7ntcoyn.js";import"./bjs-scene171-hdrFilteringFunctions-3ayVY0xu.js";import"./bjs-scene171-harmonicsFunctions-DApJav1M.js";import"./bjs-scene171-pbrBRDFFunctions-RM5jaQ1c.js";import"./bjs-scene171-reflectionFunction-CwY_U55u.js";import"./bjs-scene171-logDepthFragment-DZEy9P1O.js";import"./bjs-scene171-sceneUboDeclaration-DtOsvLb1.js";import"./bjs-scene171-clipPlaneVertex-2jmc8tKc.js";import"./bjs-scene171-bumpVertex-CwazkzV7.js";import"./bjs-scene171-mainUVVaryingDeclaration-BRvd2tD2.js";const o="openpbrFragmentDeclaration",S=`uniform float vBaseWeight;uniform vec4 vBaseColor;uniform float vBaseDiffuseRoughness;uniform vec4 vReflectanceInfo;uniform vec4 vSpecularColor;uniform vec3 vSpecularAnisotropy;uniform float vTransmissionWeight;uniform vec3 vTransmissionColor;uniform float vTransmissionDepth;uniform vec3 vTransmissionScatter;uniform float vTransmissionScatterAnisotropy;uniform float vTransmissionDispersionScale;uniform float vTransmissionDispersionAbbeNumber;uniform float vSubsurfaceWeight;uniform vec3 vSubsurfaceColor;uniform float vSubsurfaceRadius;uniform vec3 vSubsurfaceRadiusScale;uniform float vSubsurfaceScatterAnisotropy;uniform float vCoatWeight;uniform vec3 vCoatColor;uniform float vCoatRoughness;uniform float vCoatRoughnessAnisotropy;uniform float vCoatIor;uniform float vCoatDarkening;uniform float vFuzzWeight;uniform vec3 vFuzzColor;uniform float vFuzzRoughness;uniform vec2 vGeometryCoatTangent;uniform float vGeometryThickness;uniform vec3 vEmissionColor;uniform float vThinFilmWeight;uniform vec2 vThinFilmThickness;uniform float vThinFilmIor;uniform float vGeometryThinWalled;uniform vec4 vLightingIntensity;uniform float visibility;uniform vec2 renderTargetSize;
#ifdef BASE_COLOR
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=S);const r="openpbrFragmentSamplersDeclaration",A=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=A);const t="openpbrNormalMapFragmentMainFunctions",T=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=T);const a="openpbrNormalMapFragmentFunctions",N=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=N);const n="openpbrConductorReflectance",b=`#define pbr_inline
...
#endif
outParams.F0=1.0;outParams.F90=1.0;return outParams;}`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=b);const s="openpbrAmbientOcclusionFunctions",L=`float compute_specular_occlusion(const float n_dot_v,const float metallic,const float ambient_occlusion,const float roughness)
...
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=L);const f="openpbrVolumeFunctions",F=`struct OpenPBRHomogeneousVolume {vec3 extinction_coeff; 
vec3 ss_albedo; 
...
weight_sum.b<1e-5f ? unconvolved_irradiance.b : irradiance_sum.b/weight_sum.b);}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=F);const l="openpbrNormalMapFragment",O=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=O);const c="openpbrBlockNormalFinal",C=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=C);const _="openpbrBaseLayerData",D=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=D);const d="openpbrCoatLayerData",P=`float coat_weight=0.0;vec3 coat_color=vec3(1.0);float coat_roughness=0.0;float coat_roughness_anisotropy=0.0;float coat_ior=1.6;float coat_darkening=1.0;vec2 geometry_coat_tangent=vec2(1.0,0.0);
#ifdef COAT_WEIGHT
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=P);const m="openpbrThinFilmLayerData",M=`#ifdef THIN_FILM
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=M);const u="openpbrFuzzLayerData",G=`float fuzz_weight=0.0;vec3 fuzz_color=vec3(1.0);float fuzz_roughness=0.0;
#ifdef FUZZ
#ifdef FUZZ_WEIGHT
...
#endif
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=G);const g="openpbrAmbientOcclusionData",x=`vec3 ambient_occlusion=vec3(1.0);float specular_ambient_occlusion=1.0;float coat_specular_ambient_occlusion=1.0;
#ifdef AMBIENT_OCCLUSION
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=x);const E="openpbrBackgroundTransmission",y=`vec4 slab_translucent_background=vec4(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=y);const v="openpbrEnvironmentLighting",z=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=z);const p="openpbrDirectLightingInit",U=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=U);const I="openpbrDirectLighting",W=`#ifdef LIGHT{X}
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=W);const h="openpbrBlockPrePass",X=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=X);const i="openpbrPixelShader",R=`#define OPENPBR_FRAGMENT_SHADER
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=R);const fe={name:i,shader:R};export{fe as openpbrPixelShader};