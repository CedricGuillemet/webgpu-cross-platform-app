...
`
  ...
  function getCache(engine) {
    const device = engine._device;
    if (_cache3 && _cache3.device === device) {
      return _cache3;
    }
    ...
    _cache3 = { device, pipeline, meshBGL, pickingBGL, pickMatrixUbo, sceneBG };
    return _cache3;
  }
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene129.ts
  var SPLAT_URL = "https://raw.githubusercontent.com/CedricGuillemet/dump/master/Halo_Believe.splat";
  var DEFAULT_PICK_X_RATIO = 0.5;
  var DEFAULT_PICK_Y_RATIO = 0.6;
