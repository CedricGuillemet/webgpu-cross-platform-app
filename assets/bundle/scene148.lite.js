...
return vec4f(max(c,vec3f(0)),r.a);}`;
  ...
  function getNearestSampler(engine) {
  ...
  var _nearestDesc, _bilinearDesc;
  var init_samplers = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/resource/samplers.ts"() {
      "use strict";
      init_gpu_pool();
      _nearestDesc = { magFilter: "nearest", minFilter: "nearest" };
      _bilinearDesc = { magFilter: "linear", minFilter: "linear" };
    }
  });

  // ../../../Babylon-Lite/packages/babylon-lite/src/material/material-view.ts
  function createMaterialView(source, renderFeatures) {
  ...
  function isMaterialView(material) {
    const maybeView = material;
  ...
  var init_material_view = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/material/material-view.ts"() {
      "use strict";
    }
  });

  // ../../../Babylon-Lite/packages/babylon-lite/src/frame-graph/geometry-types.ts
  var ZERO, ONE, GEOMETRY_TEXTURE_DESCRIPTIONS;
  var init_geometry_types = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/frame-graph/geometry-types.ts"() {
      "use strict";
      ZERO = { r: 0, g: 0, b: 0, a: 0 };
      ONE = { r: 1, g: 1, b: 1, a: 1 };
      GEOMETRY_TEXTURE_DESCRIPTIONS = [
...
return computeFallOff${suffix}(esm, clipSpace.xy, frustumEdgeFalloff);
  ...
  var standard_material_exports = {};
  __export(standard_material_exports, {
    _computeStandardMaterialFeatures: () => _computeStandardMaterialFeatures,
    _standardFeatureKey: () => _standardFeatureKey,
    _standardShaderVariantKey: () => _standardShaderVariantKey,
    collectStdBoundTextures: () => collectStdBoundTextures,
    createStandardMaterial: () => createStandardMaterial,
    standardGroupBuilder: () => standardGroupBuilder
  });
...
${varyBody}
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/material/standard/standard-geometry-output-shader.ts
  function needsGpUbo(attachments) {
    for (const t of attachments) {
      if (t === 5 /* NORMALIZED_VIEW_DEPTH */ || t === 10 /* LINEAR_VELOCITY */) {
        return true;
      }
    }
    return false;
  ...
  function createGeometryParamsFragment(needsParamsUbo, needsVelocityVaryings, needsLocalPosVarying) {
    const bindings = needsParamsUbo ? [{ _name: "gp", _type: { _kind: "uniform-buffer" }, _visibility: STAGE_FRAGMENT11 | STAGE_VERTEX4 }] : [];
...
return out;`;
  ...
  var STAGE_FRAGMENT11, STAGE_VERTEX4;
  var init_standard_geometry_output_shader = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/material/standard/standard-geometry-output-shader.ts"() {
      "use strict";
      init_standard_pipeline();
      init_standard_flags();
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/material/standard/standard-geometry-renderable.ts
  ...
  function buildStandardGeometryRenderable(scene, mesh, view) {
    ...
    const needsUV = (features & NEEDS_UV) !== 0;
    const needsUV2 = (features & NEEDS_UV2) !== 0;
    const isAlphaBlend2 = res._alphaBlend;
    const hasThinInstances = (meshFeatures & MSH_HAS_THIN_INSTANCES) !== 0;
    const hasInstanceColor = (meshFeatures & MSH_HAS_INSTANCE_COLOR) !== 0;
    const sortCenter = [mesh.worldMatrix[12], mesh.worldMatrix[13], mesh.worldMatrix[14]];
    const update = () => {
    ...
    const r = {
      order: mesh.renderOrder ?? (isAlphaBlend2 ? 200 : 100),
      isTransparent: isAlphaBlend2,
      mesh,
      bind(eng, sig) {
        return {
          renderable: r,
  ...
  var standardGeometryGroupBuilder;
  var init_standard_geometry_renderable = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/material/standard/standard-geometry-renderable.ts"() {
      "use strict";
      init_typed_arrays();
      init_lights_ubo();
      ...
      init_gpu_pool();
      init_render_target();
      init_thin_instance_fragment();
      init_thin_instance_gpu();
      init_standard_flags();
      init_standard_pipeline();
      init_standard_geometry_output_shader();
      init_scene_helpers();
      init_collect_std_bound_textures();
      init_mesh_features();
      standardGeometryGroupBuilder = async () => {
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/material/standard/geometry-view.ts
  var geometry_view_exports = {};
  __export(geometry_view_exports, {
    createStandardGeometryMaterialView: () => createStandardGeometryMaterialView
  });
  ...
  var init_geometry_view = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/material/standard/geometry-view.ts"() {
      "use strict";
      init_material_view();
      init_standard_flags();
      init_standard_geometry_renderable();
    }
  });
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/texture/solid-texture.ts
  ...
  function createPbrTemplate(config) {
    ...
    const tex2d = (name, sampler) => [
      { _name: name, _type: { _kind: "texture", _textureType: "texture_2d<f32>" }, _visibility: STAGE_FRAGMENT12 },
      { _name: sampler, _type: { _kind: "sampler", _samplerType: "sampler" }, _visibility: STAGE_FRAGMENT12 }
    ];
    ...
    if (_esmShadowOutput) {
      _baseBindings.push({ _name: "shadowParams", _type: { _kind: "uniform-buffer" }, _visibility: STAGE_FRAGMENT12 });
    }
...
${alphaBlock}`}
  ...
  var STAGE_FRAGMENT12, BRDF_FUNCTIONS;
...
color = finalIrradiance + finalRadianceScaled + finalSpecularScaled + directDiffuse + emissive;`;
  ...
  function createIblFragment(hasNormalMap, anisoBentNormalCode = "", skyboxCalculation = "") {
    return {
      ...
      _bindings: [
        { _name: "brdfLUT", _type: { _kind: "texture", _textureType: "texture_2d<f32>" }, _visibility: STAGE_FRAGMENT13 },
        { _name: "brdfSampler_", _type: { _kind: "sampler", _samplerType: "sampler" }, _visibility: STAGE_FRAGMENT13 },
        { _name: "iblTexture", _type: { _kind: "texture", _textureType: "texture_cube<f32>" }, _visibility: STAGE_FRAGMENT13 },
        { _name: "iblSampler", _type: { _kind: "sampler", _samplerType: "sampler" }, _visibility: STAGE_FRAGMENT13 }
      ],
  ...
  var STAGE_FRAGMENT13, IBL_HELPERS, pbrExt;
...
`;
  ...
  function createReflectanceFragment(hasMetallicReflectanceMap, hasReflectanceMap, useAlphaOnlyMR, hasOcclusionUv2 = false) {
    ...
    if (hasMetallicReflectanceMap) {
      bindings.push(
        { _name: "metallicReflectanceMap", _type: { _kind: "texture", _textureType: "texture_2d<f32>" }, _visibility: STAGE_FRAGMENT14 },
        { _name: "metallicReflectanceMapSampler", _type: { _kind: "sampler", _samplerType: "sampler" }, _visibility: STAGE_FRAGMENT14 }
      );
    }
    if (hasReflectanceMap) {
      bindings.push(
        { _name: "reflectanceMap", _type: { _kind: "texture", _textureType: "texture_2d<f32>" }, _visibility: STAGE_FRAGMENT14 },
        { _name: "reflectanceMapSampler", _type: { _kind: "sampler", _samplerType: "sampler" }, _visibility: STAGE_FRAGMENT14 }
      );
    }
...
var ccDirectSpecularTerm = vec3<f32>(0.0);`
    ...
    if (hasIntensityMap) {
      bindings.push(
        { _name: "ccIntensityTexture", _type: { _kind: "texture", _textureType: "texture_2d<f32>" }, _visibility: STAGE_FRAGMENT15 },
        { _name: "ccIntensitySampler_", _type: { _kind: "sampler", _samplerType: "sampler" }, _visibility: STAGE_FRAGMENT15 }
      );
    }
    if (hasRoughnessMap) {
      bindings.push(
        { _name: "ccRoughnessTexture", _type: { _kind: "texture", _textureType: "texture_2d<f32>" }, _visibility: STAGE_FRAGMENT15 },
        { _name: "ccRoughnessSampler_", _type: { _kind: "sampler", _samplerType: "sampler" }, _visibility: STAGE_FRAGMENT15 }
      );
    }
    if (hasNormalMap) {
      bindings.push(
        { _name: "ccNormalTexture", _type: { _kind: "texture", _textureType: "texture_2d<f32>" }, _visibility: STAGE_FRAGMENT15 },
        { _name: "ccNormalSampler_", _type: { _kind: "sampler", _samplerType: "sampler" }, _visibility: STAGE_FRAGMENT15 }
      );
    }
    return {
  ...
  var STAGE_FRAGMENT15, CC_HELPERS, CC_INT_TEX, CC_INT_PLAIN, CC_ROUGH_TEX, CC_ROUGH_PLAIN, CC_NORMAL_COMPUTE, CC_TEX, pbrExt4;
...
sheenRoughnessAdjusted *= sheenMapData.a;
    ...
    if (hasSheenTexture) {
      bindings.push(
        { _name: "sheenTexture_", _type: { _kind: "texture", _textureType: "texture_2d<f32>" }, _visibility: STAGE_FRAGMENT16 },
        { _name: "sheenSampler_", _type: { _kind: "sampler", _samplerType: "sampler" }, _visibility: STAGE_FRAGMENT16 }
      );
    }
    const uboFields = [
  ...
  var STAGE_FRAGMENT16, SHEEN_HELPERS, SHEEN_DIRECT_MOD, SHEEN_IBL_MOD, SHEEN_IBL_COLOR_MOD, SHEEN_NON_IBL_MOD, pbrExt5;
...
`;
  ...
  function createIridescenceFragment(features, features2, meshFeatures) {
    ...
    if (hasIntensityMap) {
      bindings.push(
        { _name: "iridescenceTexture", _type: { _kind: "texture", _textureType: "texture_2d<f32>" }, _visibility: STAGE_FRAGMENT17 },
        { _name: "iridescenceSampler_", _type: { _kind: "sampler", _samplerType: "sampler" }, _visibility: STAGE_FRAGMENT17 }
      );
      if (hasIntensityUvTx) {
    ...
    if (hasThicknessMap) {
      bindings.push(
        { _name: "iridescenceThicknessTexture", _type: { _kind: "texture", _textureType: "texture_2d<f32>" }, _visibility: STAGE_FRAGMENT17 },
        { _name: "iridescenceThicknessSampler_", _type: { _kind: "sampler", _samplerType: "sampler" }, _visibility: STAGE_FRAGMENT17 }
      );
      if (hasThicknessUvTx) {
...
colorF0=mix(colorF0,iriF0,iriIntensity);
  ...
  var STAGE_FRAGMENT17, PBR2_HAS_IRIDESCENCE_UV_TX, PBR2_HAS_IRIDESCENCE_THICKNESS_UV_TX, PBR2_HAS_IRIDESCENCE_UV2, PBR2_HAS_IRIDESCENCE_THICKNESS_UV2, IRI_MSH_HAS_UV2, IRIDESCENCE_HELPERS, IRI_TEX, pbrExt6;
...
ssTransmittance = transmittanceBRDF_Burley(ssTranslucencyColor, ssDiffDist, ssThickness) * ssIntensity;`;
  ...
  function createSubsurfaceFragment(hasThicknessMap, hasIbl, useGltfThicknessChannel) {
    const bindings = hasThicknessMap ? [
      { _name: "thicknessTexture_", _type: { _kind: "texture", _textureType: "texture_2d<f32>" }, _visibility: STAGE_FRAGMENT18 },
      { _name: "thicknessSampler_", _type: { _kind: "sampler", _samplerType: "sampler" }, _visibility: STAGE_FRAGMENT18 }
    ] : [];
    const slots = {
      SV: SS_SCOPE_VARS,
  ...
  var SS_HELPERS, SS_SCOPE_VARS, SS_DIRECT, SS_IBL_MOD, SS_NO_IBL_MOD, STAGE_FRAGMENT18, pbrExt7;
...
finalWorld = mesh.world * influence;`;
  ...
  function createSkeletonFragment(has8Bones) {
    return {
      ...
      _vertexBindings: [
        { _name: "boneSampler", _type: { _kind: "texture", _textureType: "texture_2d<f32>", _sampleType: "unfilterable-float" }, _visibility: STAGE_VERTEX5 }
      ],
  ...
  var STAGE_VERTEX5, SKELETON_HELPERS, pbrExt10;
...
_p0: u32,
      ...
      _vertexBindings: [
        { _name: "morphTargets", _type: { _kind: "texture", _textureType: "texture_2d<f32>", _sampleType: "unfilterable-float" }, _visibility: STAGE_VERTEX6 },
        { _name: "morph", _type: { _kind: "uniform-buffer" }, _visibility: STAGE_VERTEX6 }
      ],
      _vertexSlots: {
  ...
  var STAGE_VERTEX6, MORPH_PRE_SKINNING, pbrExt11;
...
` : "";
    ...
    if (_hasOcclusionUv2) {
      extraBindings.push(
        { _name: "occlusionTexture", _type: { _kind: "texture", _textureType: "texture_2d<f32>" }, _visibility: STAGE_FRAGMENT19 },
        { _name: "occlusionSampler_", _type: { _kind: "sampler", _samplerType: "sampler" }, _visibility: STAGE_FRAGMENT19 }
      );
    }
    let vertexBodyExtra = "";
    if (_hasUv2) {
...
`;
  ...
  var pbr_material_exports = {};
  __export(pbr_material_exports, {
    _computePbrMaterialFeatures: () => _computePbrMaterialFeatures,
    collectPbrBoundTextures: () => collectPbrBoundTextures,
    createPbrMaterial: () => createPbrMaterial,
    pbrGroupBuilder: () => pbrGroupBuilder
  });
  ...
  function createPbrMaterial(props) {
    _installPbrFallbackResolver((engine) => engine._pbrFallbackTex ?? (engine._pbrFallbackTex = createSolidTexture2D(engine, 1, 1, 1)));
    const mat = {
      ...props,
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/material/pbr/pbr-geometry-output-shader.ts
  function needsGpUbo2(attachments) {
    for (const t of attachments) {
      if (t === 5 /* NORMALIZED_VIEW_DEPTH */ || t === 10 /* LINEAR_VELOCITY */) {
        return true;
      }
  ...
  function needsVelocity2(attachments) {
    return attachments.includes(10 /* LINEAR_VELOCITY */);
  }
  function needsLocalPos2(attachments) {
    return attachments.includes(2 /* LOCAL_POSITION */);
  }
  function createPbrGeometryParamsFragment(needsParamsUbo, needsVelocityVaryings, needsLocalPosVarying) {
    const bindings = needsParamsUbo ? [{ _name: "gp", _type: { _kind: "uniform-buffer" }, _visibility: STAGE_FRAGMENT20 | STAGE_VERTEX7 }] : [];
    const helpers = needsParamsUbo ? `struct gpUniforms { previousViewProjection: mat4x4<f32>, cameraNearFar: vec4<f32>, };` : "";
    const varyings = [];
    if (needsVelocityVaryings) {
      varyings.push({ _name: "vCurrentClip", _type: "vec4<f32>" }, { _name: "vPreviousClip", _type: "vec4<f32>" });
  ...
  function _ensurePbrGeometryExt(getAttachments) {
    ...
    const ext14 = {
      ...
      frag(ctx) {
        ...
        const wantsGp = needsGpUbo2(att);
        const wantsVelocity = needsVelocity2(att);
        const wantsLocalPos = needsLocalPos2(att);
    ...
    _registerPbrExt(ext14);
  }
  function attachmentExpr2(type, wg, hasIbl) {
    switch (type) {
      case 0 /* IRRADIANCE */:
...
`;
    frag = frag.replace("@fragment fn main", `${outputStruct}@fragment fn main`);
    const wg = `select(0.0, 1.0, alpha > 0.4)`;
    const writes = attachments.map((type, i) => `out.f${i} = ${attachmentExpr2(type, wg, hasIbl)};`).join("\n");
    const extraColorWrite = emitColor ? `
...
return out;`;
  ...
  var STAGE_FRAGMENT20, STAGE_VERTEX7, _pbrGeomExtRegistered;
  var init_pbr_geometry_output_shader = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/material/pbr/pbr-geometry-output-shader.ts"() {
      "use strict";
      init_pbr_flags();
      STAGE_FRAGMENT20 = 2;
      STAGE_VERTEX7 = 1;
      _pbrGeomExtRegistered = false;
    }
  });

  // ../../../Babylon-Lite/packages/babylon-lite/src/material/pbr/pbr-geometry-renderable.ts
  function _variantKey2(meshFeatures, lightMode, singleLightType) {
  ...
  function buildPbrGeometryRenderable(scene, mesh, view) {
    ...
    const meshFeatures = _computeMeshFeatures(mesh, receiveShadows);
    const variantKey = _variantKey2(meshFeatures, lightMode, singleLightType);
    const res = _ensureViewResources2(view, engine, ctx, meshFeatures, lightMode, singleLightType, variantKey);
    const features = res._features;
    ...
    const hasTI = (meshFeatures & MSH_HAS_THIN_INSTANCES) !== 0;
    const hasTIColor = (meshFeatures & MSH_HAS_INSTANCE_COLOR) !== 0;
    const syncThinInstanceBuffers2 = ctx._syncThinInstanceBuffers;
    const isAlphaBlend2 = res._alphaBlend;
    const sortCenter = [mesh.worldMatrix[12], mesh.worldMatrix[13], mesh.worldMatrix[14]];
    let _lastWorldVersion = mesh.worldMatrixVersion;
    let _lastLightsCount = scene.lights.length;
    ...
    const draw = (pass) => {
      ...
      const ti = hasTI ? mesh.thinInstances : null;
      if (ti && syncThinInstanceBuffers2) {
        slot = syncThinInstanceBuffers2(engine, ti, pass, slot, hasTIColor);
      }
      pass.setIndexBuffer(gpu.indexBuffer, gpu.indexFormat);
      if (ti && ti.count > 0) {
        pass.drawIndexed(gpu.indexCount, ti.count);
    ...
    const r = {
      ...
      bind(eng, sig) {
        return {
          renderable: r,
          pipeline: _getOrCreateGeometryPipeline2(eng, sig, view, res),
          update,
          draw
        };
      }
  ...
  function _ensureViewResources2(view, engine, ctx, meshFeatures, lightMode, singleLightType, variantKey) {
    let cache = view._geometry;
    if (!cache) {
      cache = /* @__PURE__ */ new Map();
      Object.defineProperty(view, "_geometry", { value: cache, enumerable: false, configurable: true });
    ...
    const sceneBGL = engine._getSceneBGL?.() ?? _getSceneBindGroupLayoutLocal(engine, composed);
  ...
  function _getOrCreateGeometryPipeline2(engine, sig, view, res) {
    const key = targetSignatureKey(sig);
    const cached = res._pipelines.get(key);
    if (cached) {
      return cached;
  ...
  var pbrGeometryGroupBuilder;
  var init_pbr_geometry_renderable = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/material/pbr/pbr-geometry-renderable.ts"() {
      "use strict";
      init_typed_arrays();
      init_lights_ubo();
      ...
      init_pbr_pipeline();
      init_pbr_renderable();
      init_pbr_geometry_output_shader();
      init_pbr_geometry_view();
      pbrGeometryGroupBuilder = async () => {
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/material/pbr/pbr-geometry-view.ts
  var pbr_geometry_view_exports = {};
  __export(pbr_geometry_view_exports, {
    _setActivePbrGeometryAttachments: () => _setActivePbrGeometryAttachments,
    createPbrGeometryMaterialView: () => createPbrGeometryMaterialView
  });
  ...
  var _activeAttachments;
  var init_pbr_geometry_view = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/material/pbr/pbr-geometry-view.ts"() {
      "use strict";
      init_material_view();
      init_pbr_flags();
      init_pbr_geometry_renderable();
      init_pbr_geometry_output_shader();
    }
  });
...
fn nli(i: u32) -> u32 { return meshU.li[i / 4u][i % 4u]; }`;
  ...
  function getCache(engine) {
    if (!_cache || _cachedDevice5 !== engine._device) {
      _cache = /* @__PURE__ */ new Map();
      _cachedDevice5 = engine._device;
    }
    return _cache;
  }
...
` + fsReturn + `}`
  ...
  var SENTINEL_FRAG_OUTPUT, SENTINEL_FRAG_DEPTH, SENTINEL_VTX_OUTPUT, SENTINEL_FRONT_FACING, SENTINEL_FRAG_COORD, SENTINEL_SCREEN_SIZE, _cache, _cachedDevice5;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/material/node/node-geometry-renderable.ts
  function geomWrite(type, inputs, gpRef) {
    const wg = "1.0";
    const v = inputs.get(type);
    const wp = inputs.get(1 /* WORLD_POSITION */);
    switch (type) {
      case 1 /* WORLD_POSITION */:
        return v ? `vec4<f32>(${v.expr}, ${wg})` : ZERO2(wg);
      case 2 /* LOCAL_POSITION */:
        return v ? `vec4<f32>(${v.expr}, ${wg})` : ZERO2(wg);
      case 8 /* WORLD_NORMAL */:
        return v ? `vec4<f32>(normalize(${v.expr}) * 0.5 + vec3<f32>(0.5), ${wg})` : ZERO2(wg);
      case 7 /* VIEW_NORMAL */:
        return v ? `vec4<f32>(normalize(${v.expr}), ${wg})` : ZERO2(wg);
      case 3 /* REFLECTIVITY */:
        return v ? `(${v.expr}) * ${wg}` : ZERO2(wg);
      case 9 /* ALBEDO */:
        return v ? `vec4<f32>(${v.expr}, ${wg})` : ZERO2(wg);
      case 0 /* IRRADIANCE */:
        return v ? `vec4<f32>(${v.expr}, ${wg})` : ZERO2(wg);
      ...
      case 4 /* VIEW_DEPTH */:
        ...
        return wp ? `vec4<f32>((scene.view * vec4<f32>(${wp.expr}, 1.0)).z, 0.0, 0.0, ${wg})` : ZERO2(wg);
      case 5 /* NORMALIZED_VIEW_DEPTH */:
        if (v) {
          return `vec4<f32>(${v.expr}, 0.0, 0.0, ${wg})`;
        }
...
@group(1) @binding(${binding}) var<uniform> nmeGeom: NmeGeomParams;`,
  ...
  var nodeGeometryGroupBuilder, ZERO2;
  var init_node_geometry_renderable = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/material/node/node-geometry-renderable.ts"() {
      "use strict";
      init_typed_arrays();
      init_gpu_flags();
      ...
      init_node_pipeline();
      init_node_material();
      init_node_renderable();
      nodeGeometryGroupBuilder = async () => {
      ...
      ZERO2 = (wg) => `vec4<f32>(0.0, 0.0, 0.0, ${wg})`;
    }
  });

  // ../../../Babylon-Lite/packages/babylon-lite/src/material/node/node-geometry-view.ts
  var node_geometry_view_exports = {};
  __export(node_geometry_view_exports, {
    createNodeGeometryMaterialView: () => createNodeGeometryMaterialView
  });
  ...
  var init_node_geometry_view = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/material/node/node-geometry-view.ts"() {
      "use strict";
      init_material_view();
      init_node_flags();
      init_node_geometry_renderable();
    }
  });
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/math/vec3-ctor.ts
  function vec3(x, y, z) {
    return { x, y, z };
  }

  // ../../../Babylon-Lite/packages/babylon-lite/src/scene/scene-camera.ts
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/frame-graph/frame-graph-actions.ts
  init_frame_graph();
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/frame-graph/geometry-renderer-task.ts
  init_typed_arrays();
  init_render_target();

  // ../../../Babylon-Lite/packages/babylon-lite/src/engine/render-target-mrt.ts
  init_gpu_flags();
  ...
  function buildRenderTargetMrt(rt, engine) {
    ...
    const desc = rt._descriptor;
    const { width, height } = resolveSize2(desc);
    rt._width = width;
    rt._height = height;
    const device = engine._device;
  ...
  function createGeometryRendererTask(config, engine, scene) {
    ...
    const needsVelocity3 = types.includes(10 /* LINEAR_VELOCITY */);
    const needsParams = needsVelocity3 || types.includes(5 /* NORMALIZED_VIEW_DEPTH */);
    ...
    const task = {
      ...
      geometryIrradianceTexture: typeAccessors[0 /* IRRADIANCE */],
      geometryWorldPositionTexture: typeAccessors[1 /* WORLD_POSITION */],
      geometryLocalPositionTexture: typeAccessors[2 /* LOCAL_POSITION */],
      geometryReflectivityTexture: typeAccessors[3 /* REFLECTIVITY */],
      geometryViewDepthTexture: typeAccessors[4 /* VIEW_DEPTH */],
      geometryNormalizedViewDepthTexture: typeAccessors[5 /* NORMALIZED_VIEW_DEPTH */],
      geometryScreenspaceDepthTexture: typeAccessors[6 /* SCREENSPACE_DEPTH */],
      geometryViewNormalTexture: typeAccessors[7 /* VIEW_NORMAL */],
      geometryWorldNormalTexture: typeAccessors[8 /* WORLD_NORMAL */],
      geometryAlbedoTexture: typeAccessors[9 /* ALBEDO */],
      geometryLinearVelocityTexture: typeAccessors[10 /* LINEAR_VELOCITY */],
      ...
      async _preload() {
        ...
        if (hasStandard) {
          loads.push(
            (async () => {
              const [viewMod, matMod] = await Promise.all([Promise.resolve().then(() => (init_geometry_view(), geometry_view_exports)), Promise.resolve().then(() => (init_standard_material(), standard_material_exports))]);
        ...
        if (hasPbr) {
          loads.push(
            (async () => {
              const [viewMod, matMod] = await Promise.all([Promise.resolve().then(() => (init_pbr_geometry_view(), pbr_geometry_view_exports)), Promise.resolve().then(() => (init_pbr_material(), pbr_material_exports))]);
        ...
        if (hasNode) {
          loads.push(
            (async () => {
              const viewMod = await Promise.resolve().then(() => (init_node_geometry_view(), node_geometry_view_exports));
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/frame-graph/post-process-task.ts
  init_typed_arrays();
  init_gpu_flags();
  init_render_target();
  init_samplers();
  var fullscreenVertexWGSL = (extraOutput, extraMain) => `struct PostProcessVertexOutput{@builtin(position) position:vec4f,@location(0) uv:vec2f${extraOutput}}
@vertex fn postProcessVertex(@builtin(vertex_index) vertexIndex:u32)->PostProcessVertexOutput{var positions=array<vec2f,3>(vec2f(-1,-1),vec2f(3,-1),vec2f(-1,3));let p=positions[vertexIndex];var out:PostProcessVertexOutput;out.position=vec4f(p,0,1);out.uv=vec2f(p.x*0.5+0.5,0.5-p.y*0.5);${extraMain}return out;}`;
  var SOURCE_WGSL = `@group(0) @binding(0) var sourceSampler:sampler;
...
fn readPostProcessSource(uv:vec2f)->vec4f{let dims=vec2f(textureDimensions(sourceTextureSampler));let p=clamp(floor(uv*dims)+vec2f(0.5),vec2f(0.5),dims-vec2f(0.5));return textureSampleLevel(sourceTextureSampler,sourceSampler,p/dims,0);}`;
  var FRAGMENT_WRAPPER_WGSL = `@fragment fn postProcessFragment(input:PostProcessVertexOutput)->@location(0) vec4f{return applyPostProcess(samplePostProcessSource(input.uv),input.uv);}`;
  function createPostProcessTask(config, engine, scene) {
  ...
  function createPostProcessGpuState(task, engine) {
    ...
    task._uniformBuffer ?? (task._uniformBuffer = createUniformBuffer2(task, engine));
    task._uniformData ?? (task._uniformData = createUniformData(task));
    writePostProcessUniforms(task, engine);
    const bgl = getBindGroupLayout(task, engine);
    task._pipelineLayout ?? (task._pipelineLayout = engine._device.createPipelineLayout({ label: `${task.name}-pipeline-layout`, bindGroupLayouts: [bgl] }));
    const signature = {
      _colorFormat: format,
    ...
    task._pipeline = engine._device.createRenderPipeline({
      ...
      fragment: {
        ...
        targets: [{ format, blend: alphaModeToBlend2(task.alphaMode) }]
      },
      primitive: { topology: "triangle-list" },
  ...
  function prepareOutputTarget(task) {
  ...
  function createInternalTarget(name, source) {
  ...
  function internalTargetKey(source) {
  ...
  function getBindGroupLayout(task, engine) {
...
${task._shader.fragmentWrapperWGSL ?? FRAGMENT_WRAPPER_WGSL}`;
  ...
  function createUniformBuffer2(task, engine) {
  ...
  function createUniformData(task) {
    const size = align16(task._shader.uniformByteLength ?? 0);
    return size === 0 ? null : new F32(size / 4);
  }
  function writePostProcessUniforms(task, engine) {
    if ((task._shader.uniformByteLength ?? 0) === 0) {
      return;
    }
    task._uniformData.fill(0);
    task._shader.writeUniforms?.(task._uniformData);
    engine._device.queue.writeBuffer(task._uniformBuffer, 0, task._uniformData);
  }
  function applyColorAttachmentState(att, rt, clear) {
    att.view = rt._colorView;
    att.resolveTarget = void 0;
    att.loadOp = clear ? "clear" : "load";
  }
  function applyViewport(pass, viewport, rt) {
    if (!viewport) {
      return;
    }
  ...
  function alphaModeToBlend2(mode) {
    switch (mode) {
      case 1:
        return {
          color: { srcFactor: "src-alpha", dstFactor: "one", operation: "add" },
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/post-process/circle-of-confusion.ts
  var COC_EXTRA_TEXTURE_WGSL = `@group(0) @binding(2) var cocDepthTexture:texture_2d<f32>;`;
  var COC_UNIFORM_WGSL = `struct CircleOfConfusionParams{focusDistance:f32,cocPrecalculation:f32,minZ:f32,maxZRange:f32}
@group(0) @binding(3) var<uniform> cocParams:CircleOfConfusionParams;`;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/post-process/depth-of-field.ts
  init_render_target();

  // ../../../Babylon-Lite/packages/babylon-lite/src/post-process/depth-of-field-blur.ts
  var MAX_VERTEX_BLUR_SAMPLES = 8;
  var DOF_BLUR_EXTRA_TEXTURE_WGSL = `@group(0) @binding(2) var dofCocTexture:texture_2d<f32>;`;
  var DOF_BLUR_UNIFORM_WGSL = `struct DofBlurParams{delta:vec2f,p0:f32,p1:f32}
@group(0) @binding(3) var<uniform> dofBlurParams:DofBlurParams;`;
  var DOF_BLUR_COC_SAMPLE_WGSL = `fn sampleCoC(uv:vec2f)->f32{return textureSample(dofCocTexture,sourceSampler,uv).r;}`;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/post-process/depth-of-field-merge.ts
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene148.ts
  var POWERPLANT_URL = "https://assets.babylonjs.com/meshes/PowerPlant/powerplant.glb";
  async function main() {
    ...
    const geomTask = createGeometryRendererTask(
      {
        name: "scene148-geom",
        samples: 1,
        textureDescriptions: [{ type: 4 /* VIEW_DEPTH */, format: "r16float", clearValue: { r: 0, g: 0, b: 0, a: 0 } }]
      },
      engine,
      scene
    );
