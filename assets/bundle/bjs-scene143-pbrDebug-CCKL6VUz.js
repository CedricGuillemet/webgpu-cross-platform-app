import{S as e}from"./bjs-scene143.js";import"./bjs-scene143-mainUVVaryingDeclaration-Iw7Q-sQm.js";import"./bjs-scene143-imageProcessingFunctions-C0eXZoQZ.js";const t="pbrFragmentExtraDeclaration",s=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=s);const o="subSurfaceScatteringFunctions",d=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=d);const i="pbrHelperFunctions",g=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=g);const r="pbrDirectLightingSetupFunctions",u=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=u);const a="pbrDirectLightingFalloffFunctions",E=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=E);const l="pbrDirectLightingFunctions",h=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=h);const n="pbrBlockNormalGeometric",D=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=D);const f="pbrBlockImageProcessing",L=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=L);const c="pbrDebug",C=`#if DEBUGMODE>0
