import{S as e}from"./bjs-scene171.js";const t="lightFragmentDeclaration",l=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=l);const o="lightUboDeclaration",c=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=v);const a="shadowsFragmentFunctions",n=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=n);const r="imageProcessingDeclaration",d=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=d);const s="imageProcessingFunctions",h=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=h);