...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=A);const a="openpbrNormalMapFragmentMainFunctions",T=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=T);const t="openpbrNormalMapFragmentFunctions",N=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=N);const n="openpbrConductorReflectance",b=`#define pbr_inline
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=R);const q={name:i,shader:R};export{q as openpbrPixelShader};