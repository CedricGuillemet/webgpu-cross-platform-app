...
${varyBody}
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/physics/havok-floating-origin.ts
  var havok_floating_origin_exports = {};
  __export(havok_floating_origin_exports, {
    createHavokFloatingOriginContext: () => createHavokFloatingOriginContext
  });
  ...
  var init_havok_floating_origin = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/physics/havok-floating-origin.ts"() {
      "use strict";
    }
  });
  ...
  async function enableHavokFloatingOrigin(world, floatingOriginWorldRadius = 1e5) {
    const fo = await Promise.resolve().then(() => (init_havok_floating_origin(), havok_floating_origin_exports));
  ...
  function _syncBodyToNode2(hknp, body) {
    const t = hknp.HP_Body_GetQTransform(body._hkBody)[1];
    const pos = t[0];
    const rot = t[1];
    const node = body.node;
  ...
  function _syncNodeToBody2(hknp, body) {
    const node = body.node;
    const p = node.position;
    const q = node.rotationQuaternion;
    hknp.HP_Body_SetQTransform(body._hkBody, [
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene209.ts
  var OFFSET = 5e6;
  async function main() {
    ...
    createPhysicsAggregate(world, sphere, 0 /* SPHERE */, {
      mass: 1,
      restitution: 0.75
    });
    createPhysicsAggregate(world, ground, 3 /* BOX */, {
      mass: 0
    });
    let settleFrames = 0;
