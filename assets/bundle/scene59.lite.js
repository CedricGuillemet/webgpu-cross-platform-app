...
${makeBillboardFragmentWgsl(depthMode)}`;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/sprite/billboard-sprite-handle.ts
  init_typed_arrays();
  init_billboard_sprite();
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/sprite/billboard-sprite-handle-animation.ts
  function playBillboardSpriteAnimation(manager, handle, from, to, loop, delayMs, options) {
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene59.ts
  var CAMERA_POSITION = { x: 0, y: 1.05, z: -5.6 };
  var CAMERA_TARGET = { x: 0, y: 0.25, z: 0.75 };
  async function main() {
