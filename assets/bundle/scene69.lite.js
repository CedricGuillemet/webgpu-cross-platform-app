...
`;
  ...
  // ../../../Babylon-Lite/lab/lite/src/shared/scene69-nme.ts
  var SCENE69_NME_JSON = {
    tags: null,
    ignoreAlpha: false,
    ...
    blocks: [
      ...
      // ── Sheen parameters (scene 69 additions) ──
      {
        customType: "BABYLON.InputBlock",
        id: 30,
        name: "shIntensity",
      ...
      {
        customType: "BABYLON.SheenBlock",
        id: 33,
        name: "Sheen",
        target: 4,
        inputs: [
          { name: "intensity", inputName: "intensity", targetBlockId: 30, targetConnectionName: "output" },
          { name: "color", inputName: "color", targetBlockId: 31, targetConnectionName: "output" },
          { name: "roughness", inputName: "roughness", targetBlockId: 32, targetConnectionName: "output" }
        ],
        outputs: [{ name: "sheen" }],
        albedoScaling: false
      },
      // PBR-MR — same as scene 68 + sheen input wired.
      {
        ...
        inputs: [
          ...
          { name: "sheen", inputName: "sheen", targetBlockId: 33, targetConnectionName: "sheen" },
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene69.ts
  async function main() {
