import{S as e}from"./bjs-scene83.js";import"./bjs-scene83-harmonicsFunctions-BSVdcG5z.js";const r="prePassDeclaration",Y=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=Y);const a="oitDeclaration",w=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=w);const n="pbrFragmentExtraDeclaration",X=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=X);const f="samplerFragmentAlternateDeclaration",k=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=k);const t="pbrFragmentReflectionDeclaration",z=`#ifdef REFLECTION
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=z);const o="pbrFragmentSamplersDeclaration",K=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=q);const s="pbrHelperFunctions",Z=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=Z);const d="pbrDirectLightingSetupFunctions",j=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=j);const E="pbrDirectLightingFalloffFunctions",J=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=J);const u="hdrFilteringFunctions",Q=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=Q);const S="pbrBlockReflectance0",ee=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=ee);const m="pbrDirectLightingFunctions",ie=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=ie);const v="pbrIBLFunctions",re=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=re);const R="pbrBlockAlbedoOpacity",ae=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=ae);const p="pbrBlockReflectivity",ne=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
diffuseRoughness: f32,
reflectanceF0: f32,
...
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=ne);const C="pbrBlockAmbientOcclusion",fe=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=fe);const A="pbrBlockAlphaFresnel",te=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=te);const I="pbrBlockAnisotropic",oe=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=oe);const N="pbrBlockReflection",ce=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=ce);const L="pbrBlockSheen",le=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=le);const O="pbrBlockClearcoat",se=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=se);const T="pbrBlockIridescence",de=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=de);const g="pbrBlockSubSurface",Ee=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=Ee);const h="pbrBlockNormalGeometric",ue=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=ue);const _="pbrBlockNormalFinal",Se=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=Se);const D="depthPrePass",me=`#ifdef DEPTHPREPASS
#if !defined(PREPASS) && !defined(ORDER_INDEPENDENT_TRANSPARENCY)
fragmentOutputs.color= vec4f(0.,0.,0.,1.0);
#endif
return fragmentOutputs;
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=me);const M="pbrBlockLightmapInit",ve=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=ve);const F="pbrBlockGeometryInfo",Re=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[F]||(e.IncludesShadersStoreWGSL[F]=Re);const P="pbrBlockReflectance",pe=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=pe);const U="pbrBlockDirectLighting",Ce=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[U]||(e.IncludesShadersStoreWGSL[U]=Ce);const b="pbrBlockFinalLitComponents",Ae=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[b]||(e.IncludesShadersStoreWGSL[b]=Ae);const B="pbrBlockFinalUnlitComponents",Ie=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[B]||(e.IncludesShadersStoreWGSL[B]=Ie);const G="pbrBlockFinalColorComposition",Ne=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[G]||(e.IncludesShadersStoreWGSL[G]=Ne);const y="pbrBlockImageProcessing",Le=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=Le);const V="pbrBlockPrePass",Oe=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[V]||(e.IncludesShadersStoreWGSL[V]=Oe);const x="oitFragment",Te=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=Te);const H="pbrDebug",ge=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[H]||(e.IncludesShadersStoreWGSL[H]=ge);const i="pbrPixelShader",W=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=W);const De={name:i,shader:W};export{De as pbrPixelShaderWGSL};