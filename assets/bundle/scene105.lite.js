...
`;
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene105.ts
  var PHYSICS_FPS = 60;
  ...
  var PLATFORM_POS = { x: -4, y: 0, z: -12 };
  var PLATFORM_SIZE = { w: 4, h: 0.2, d: 4 };
  var PLATFORM_ROT_PER_STEP = 5e-3;
  var PLATFORM_TIME_PER_STEP = 1 / PHYSICS_FPS;
  var OBSTACLES = [
  ...
  async function main() {
    ...
    const platformAgg = createPhysicsAggregate(world, platform, 3 /* BOX */, {
      mass: 0,
      extents: { x: PLATFORM_SIZE.w, y: PLATFORM_SIZE.h, z: PLATFORM_SIZE.d }
    });
    setPhysicsBodyMotionType(world, platformAgg.body, 1 /* ANIMATED */);
    if (!autoTest) {
