import{S as e}from"./bjs-scene23.js";import"./bjs-scene23-oitFragment-BGp4CSu_.js";import"./bjs-scene23-harmonicsFunctions-boifNM0U.js";import"./bjs-scene23-mainUVVaryingDeclaration-CUCUqVuW.js";import"./bjs-scene23-logDepthFragment-DGH5YyTz.js";import"./bjs-scene23-fogFragment-BWp06kSV.js";import"./bjs-scene23-logDepthDeclaration-4ZiM5nZq.js";import"./bjs-scene23-helperFunctions-DetGrqwO.js";const n="pbrFragmentDeclaration",x=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=x);const a="pbrFragmentExtraDeclaration",W=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=W);const t="samplerFragmentAlternateDeclaration",X=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=X);const o="pbrFragmentReflectionDeclaration",Y=`#ifdef REFLECTION
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=Y);const r="pbrFragmentSamplersDeclaration",k=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=k);const f="subSurfaceScatteringFunctions",w=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=w);const c="importanceSampling",z=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=z);const l="pbrHelperFunctions",K=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=K);const d="pbrDirectLightingSetupFunctions",$=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=$);const s="pbrDirectLightingFalloffFunctions",q=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=q);const E="hdrFilteringFunctions",Z=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=Z);const R="pbrDirectLightingFunctions",j=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=j);const u="pbrIBLFunctions",J=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=J);const C="pbrBlockAlbedoOpacity",Q=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=Q);const S="pbrBlockReflectivity",ee=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=ee);const m="pbrBlockAmbientOcclusion",ie=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=ie);const A="pbrBlockAlphaFresnel",ne=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=ne);const I="pbrBlockAnisotropic",ae=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=ae);const v="pbrBlockReflection",te=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=te);const N="pbrBlockSheen",oe=`#ifdef SHEEN
...
return outParams;}
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=re);const O="pbrBlockIridescence",fe=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=fe);const p="pbrBlockSubSurface",ce=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=ce);const L="pbrBlockReflectance0",le=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=le);const g="pbrClusteredLightingFunctions",de=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=de);const _="pbrBlockNormalGeometric",se=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=se);const h="pbrBlockNormalFinal",Ee=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=Ee);const D="pbrBlockLightmapInit",Re=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=Re);const M="pbrBlockGeometryInfo",ue=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=ue);const F="pbrBlockReflectance",Ce=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=Ce);const P="pbrBlockDirectLighting",Se=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=Se);const U="pbrBlockFinalLitComponents",me=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=me);const b="pbrBlockFinalUnlitComponents",Ae=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=Ae);const B="pbrBlockFinalColorComposition",Ie=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=Ie);const y="pbrBlockImageProcessing",ve=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=ve);const G="pbrBlockPrePass",Ne=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=Ne);const V="pbrDebug",Te=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=Te);const i="pbrPixelShader",H=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=H);const Fe={name:i,shader:H};export{Fe as pbrPixelShader};