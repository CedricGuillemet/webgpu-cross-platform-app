...
`;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/material/material-dirty.ts
  function markMaterialUboDirty(materialOrView) {
    const source = getMaterialSource(materialOrView);
    source._uboVersion++;
  }
  var init_material_dirty = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/material/material-dirty.ts"() {
      "use strict";
      init_material_view();
    }
...
`;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/material/tracking/tracking-primitives.ts
  ...
  function trackSubProps(parent, sub, keys) {
  ...
  var init_tracking_primitives = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/material/tracking/tracking-primitives.ts"() {
      "use strict";
      init_material_dirty();
    }
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/material/tracking/pbr-tracking.ts
  ...
  var init_pbr_tracking = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/material/tracking/pbr-tracking.ts"() {
      init_tracking_primitives();
    }
  });
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene23.ts
  init_pbr_tracking();
  async function main() {
