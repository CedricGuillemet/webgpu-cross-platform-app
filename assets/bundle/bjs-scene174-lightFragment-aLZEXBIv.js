import{S as e}from"./bjs-scene174.js";const i="clusteredLightingFunctions",n=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=n);const t="decalFragment",f=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=f);const o="lightFragment",d=`#ifdef LIGHT{X}
