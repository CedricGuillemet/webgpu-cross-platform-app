import{S as e}from"./bjs-scene12.js";const r="prePassDeclaration",h=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=m);const o="imageProcessingDeclaration",S=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=S);const f="fogFragmentDeclaration",x=`#ifdef FOG
...
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=x);const i="imageProcessingFunctions",w=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=w);const s="shadowsFragmentFunctions",g=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=g);const v="ltcHelperFunctions",T=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=T);const c="clusteredLightingFunctions",D=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
