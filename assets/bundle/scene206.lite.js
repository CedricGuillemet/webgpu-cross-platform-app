...
${varyBody}
  ...
  var billboardBlendAlpha, billboardBlendCutout;
...
${makeBillboardFragmentWgsl(depthMode)}`;
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene206.ts
  var OFFSET = 5e6;
  var CAMERA_ALPHA = -Math.PI / 2;
  var CAMERA_BETA = 1.52797;
  var CAMERA_RADIUS = 7.00643;
  var CAMERA_TARGET = { x: OFFSET, y: 0.75, z: OFFSET + 1 };
  async function main() {
