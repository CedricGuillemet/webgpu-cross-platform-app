...
(() => {
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/frame-graph/shadow-inputs.ts
  function getShadowTaskInputs() {
    shadowTaskInputs ?? (shadowTaskInputs = /* @__PURE__ */ new WeakMap());
  ...
  var shadowTaskInputs, shadowTaskInputPreloader;
  var init_shadow_inputs = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/frame-graph/shadow-inputs.ts"() {
      "use strict";
      shadowTaskInputs = null;
      shadowTaskInputPreloader = null;
    }
  });

  // ../../../Babylon-Lite/packages/babylon-lite/src/frame-graph/shadow-task.ts
  var shadow_task_exports = {};
  __export(shadow_task_exports, {
    createShadowTask: () => createShadowTask
  });
  ...
  async function ensureShadowTask(engine, scene) {
    const { createShadowTask: createShadowTask2 } = await Promise.resolve().then(() => (init_shadow_task(), shadow_task_exports));
    scene._frameGraph._tasks.unshift(createShadowTask2(engine, scene));
  }
  var byOrder;
...
@fragment fn fs(v:V)->@location(0)vec4f{return textureSample(t,s,v.u);}`;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/material/standard/no-color-view.ts
  var no_color_view_exports = {};
  __export(no_color_view_exports, {
    createStandardNoColorMaterialView: () => createStandardNoColorMaterialView
  });
  function createStandardNoColorMaterialView(source) {
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/material/shader/no-color-view.ts
  var no_color_view_exports2 = {};
  __export(no_color_view_exports2, {
    createShaderNoColorMaterialView: () => createShaderNoColorMaterialView
  });
  function createShaderNoColorMaterialView(source) {
    return createMaterialView(source, { features: 0 });
  }
  var init_no_color_view2 = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/material/shader/no-color-view.ts"() {
      "use strict";
      init_material_view();
    }
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/material/pbr/no-color-view.ts
  var no_color_view_exports3 = {};
  __export(no_color_view_exports3, {
    createPbrNoColorMaterialView: () => createPbrNoColorMaterialView
  });
  function createPbrNoColorMaterialView(source) {
...
`;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/material/node/no-color-view.ts
  var no_color_view_exports4 = {};
  __export(no_color_view_exports4, {
    createNodeNoColorMaterialView: () => createNodeNoColorMaterialView
  });
  function createNodeNoColorMaterialView(source) {
    const features = source._renderFeatures ?? { features: 0 };
    return createMaterialView(source, { features: features.features | NODE_NO_COLOR_OUTPUT });
  }
  var init_no_color_view4 = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/material/node/no-color-view.ts"() {
      "use strict";
      init_material_view();
      init_node_flags();
...
`;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/shadow/shadow-base.ts
  init_typed_arrays();
  init_gpu_buffers();
  init_pack_mat4_into_f32();
  init_matrix_allocator();
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/shadow/pcf-shadow-task-hooks.ts
  init_typed_arrays();
  init_render_task();
  init_pack_mat4_into_f32();
  var createStandardNoColorMaterialView2;
  var createPbrNoColorMaterialView2;
  var createNodeNoColorMaterialView2;
  var createShaderNoColorMaterialView2;
  async function preloadPcfShadowTaskState(casterMeshes) {
    ...
    if (needsStandard && !createStandardNoColorMaterialView2) {
      loads.push(
        Promise.resolve().then(() => (init_no_color_view(), no_color_view_exports)).then((module) => {
          createStandardNoColorMaterialView2 = module.createStandardNoColorMaterialView;
        })
      );
    }
    if (needsPbr && !createPbrNoColorMaterialView2) {
      loads.push(
        Promise.resolve().then(() => (init_no_color_view3(), no_color_view_exports3)).then((module) => {
          createPbrNoColorMaterialView2 = module.createPbrNoColorMaterialView;
        })
      );
    }
    if (needsNode && !createNodeNoColorMaterialView2) {
      loads.push(
        Promise.resolve().then(() => (init_no_color_view4(), no_color_view_exports4)).then((module) => {
          createNodeNoColorMaterialView2 = module.createNodeNoColorMaterialView;
        })
      );
    }
    if (needsShader && !createShaderNoColorMaterialView2) {
      loads.push(
        Promise.resolve().then(() => (init_no_color_view2(), no_color_view_exports2)).then((module) => {
          createShaderNoColorMaterialView2 = module.createShaderNoColorMaterialView;
        })
      );
    }
    await Promise.all(loads);
  ...
  function getNoColorView(material, cache) {
    ...
    let view;
    if (family === "standard") {
      view = createStandardNoColorMaterialView2(material);
    } else if (family === "pbr") {
      view = createPbrNoColorMaterialView2(material);
    } else if (family === "node") {
      view = createNodeNoColorMaterialView2(material);
    } else if (family === "shader") {
      view = createShaderNoColorMaterialView2(material);
    }
    cache.set(material, view);
    return view;
  }

  // ../../../Babylon-Lite/packages/babylon-lite/src/shadow/pcf-directional-shadow-generator.ts
  init_typed_arrays();
  init_gpu_flags();
  ...
  // ../../../Babylon-Lite/lab/lite/src/shared/scene72-nme.ts
  var SCENE72_NME_GZIP_BASE64 = "";
  function getScene72Nme() {
    return decodeGzipBase64Json(SCENE72_NME_GZIP_BASE64).then(restoreInputNameAliases);
  }

  // ../../../Babylon-Lite/lab/lite/src/lite/scene72.ts
  function sanitize9(name) {
    return name.replace(/[^A-Za-z0-9_]/g, "_");
  }
  async function loadSnippetTextures(engine, json) {
    ...
    for (const b of blocks) {
      ...
      const tex = b.texture;
      const url = tex?.url && tex.url.length > 0 ? tex.url : tex?.name && tex.name.startsWith("data:") ? tex.name : void 0;
      if (!url) continue;
      const key = sanitize9(b.name || `tex${b.id}`);
  ...
  async function loadScene72BlockEmitter(className) {
    switch (className) {
      ...
      case "AnisotropyBlock":
        return (await Promise.resolve().then(() => (init_anisotropy_block(), anisotropy_block_exports))).emitter;
      case "ClearCoatBlock":
      ...
      case "LerpBlock":
        return (await Promise.resolve().then(() => (init_lerp_block(), lerp_block_exports))).emitter;
      case "MultiplyBlock":
      ...
      case "RefractionBlock":
        return (await Promise.resolve().then(() => (init_refraction_block(), refraction_block_exports))).emitter;
      case "SheenBlock":
        return (await Promise.resolve().then(() => (init_sheen_block(), sheen_block_exports))).emitter;
      case "SubSurfaceBlock":
        return (await Promise.resolve().then(() => (init_subsurface_block(), subsurface_block_exports))).emitter;
      case "SubtractBlock":
        return (await Promise.resolve().then(() => (init_subtract_block(), subtract_block_exports))).emitter;
      case "TextureBlock":
  ...
  async function main() {
    ...
    const textures = { ...fallback2, ...loaded };
