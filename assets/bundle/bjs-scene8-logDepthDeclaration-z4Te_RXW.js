import{S as e}from"./bjs-scene8.js";const a="sceneUboDeclaration",t=`layout(std140,column_major) uniform;uniform Scene {mat4 viewProjection;
#ifdef MULTIVIEW
mat4 viewProjectionR;
#endif 
mat4 view;mat4 projection;vec4 vEyePosition;mat4 inverseProjection;};
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=t);const c="meshUboDeclaration",v=`#ifdef WEBGL2
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=m);const n="logDepthDeclaration",f=`#ifdef LOGARITHMICDEPTH
uniform float logarithmicDepthConstant;varying float vFragmentDepth;
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=f);