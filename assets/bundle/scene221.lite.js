...
`
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/mesh/create-polyhedron.ts
  init_typed_arrays();

  // ../../../Babylon-Lite/packages/babylon-lite/src/mesh/polyhedron-data.ts
  var POLYHEDRA = [
    {
      vertex: [
        [0, 0, 1.732051],
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/gizmo/axis-drag-gizmo.ts
  init_scene_core();
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/gizmo/plane-drag-gizmo.ts
  init_scene_core();
...
return vec4<f32>(shaderUniforms.rotationColor,min(intensity*0.25,0.8))*opacity;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/gizmo/axis-scale-gizmo.ts
  init_scene_core();
  var UNIFORM_OCTAHEDRON_SIZE = 0.028;
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene221.ts
  async function main() {
