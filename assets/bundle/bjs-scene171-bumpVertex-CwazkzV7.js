import{S as e}from"./bjs-scene171.js";const t="morphTargetsVertexGlobalDeclaration",a=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=a);const r="morphTargetsVertexDeclaration",f=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=f);const n="morphTargetsVertexGlobal",o=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
float vertexID;
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=o);const d="morphTargetsVertex",T=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=T);const i="bumpVertex",R=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
