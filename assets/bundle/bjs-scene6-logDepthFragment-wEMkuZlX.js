import{S as e}from"./bjs-scene6.js";const t="lightFragmentDeclaration",f=`#ifdef LIGHT{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=v);const r="clusteredLightingFunctions",u=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=u);const a="shadowsFragmentFunctions",p=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=p);const s="reflectionFunction",S=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=S);const n="imageProcessingDeclaration",m=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=m);const l="imageProcessingFunctions",g=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=g);const d="lightFragment",w=`#ifdef LIGHT{X}
