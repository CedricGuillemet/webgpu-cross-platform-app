import{S as e}from"./bjs-scene174.js";const i="bonesDeclaration",s=`#if NUM_BONE_INFLUENCERS>0
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=o);const r="instancesDeclaration",c=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=c);const n="clipPlaneVertexDeclaration",l=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=I);const m="clipPlaneVertex",u=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=u);