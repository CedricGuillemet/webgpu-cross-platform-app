import{S as e}from"./bjs-scene54.js";const i="bonesDeclaration",c=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=c);const t="bakedVertexAnimationDeclaration",l=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=l);const r="instancesDeclaration",E=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=E);const n="clipPlaneVertexDeclaration",N=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=N);const a="instancesVertex",I=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=I);const f="bonesVertex",S=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=S);const d="bakedVertexAnimation",u=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=u);const m="clipPlaneVertex",x=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=x);const s="fogVertex",A=`#ifdef FOG
vFogDistance=(view*worldPos).xyz;
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=A);const o="vertexColorMixing",T=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
vColor=vec4(1.0);
#ifdef VERTEXCOLOR
#ifdef VERTEXALPHA
vColor*=colorUpdated;
