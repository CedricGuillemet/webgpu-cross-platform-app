...
`;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/material/standard/esm-shadow-view.ts
  var esm_shadow_view_exports = {};
  __export(esm_shadow_view_exports, {
    createStandardEsmShadowMaterialView: () => createStandardEsmShadowMaterialView
  });
  ...
  var STANDARD_ESM_SHADOW_DEPTH_CODE;
  var init_esm_shadow_view = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/material/standard/esm-shadow-view.ts"() {
      "use strict";
      init_material_view();
      init_standard_flags();
      STANDARD_ESM_SHADOW_DEPTH_CODE = `let depthMetricSM = (input.clipPos.z + shadowParams.depthValues.x) / shadowParams.depthValues.y + shadowParams.biasAndScale.x;
let depthSM = clamp(exp(-min(87.0, shadowParams.biasAndScale.z * depthMetricSM)), 0.0, 1.0);
return vec4<f32>(depthSM, 1.0, 1.0, 1.0);`;
    }
  });

  // ../../../Babylon-Lite/packages/babylon-lite/src/material/pbr/esm-shadow-view.ts
  var esm_shadow_view_exports2 = {};
  __export(esm_shadow_view_exports2, {
    createPbrEsmShadowMaterialView: () => createPbrEsmShadowMaterialView
  });
  ...
  var PBR_ESM_SHADOW_DEPTH_CODE;
  var init_esm_shadow_view2 = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/material/pbr/esm-shadow-view.ts"() {
      "use strict";
      init_material_view();
      init_pbr_flags();
      PBR_ESM_SHADOW_DEPTH_CODE = `let depthMetricSM = (input.clipPos.z + shadowParams.depthValues.x) / shadowParams.depthValues.y + shadowParams.biasAndScale.x;
let depthSM = clamp(exp(-min(87.0, shadowParams.biasAndScale.z * depthMetricSM)), 0.0, 1.0);
return vec4<f32>(depthSM, 1.0, 1.0, 1.0);`;
    }
  });

  // ../../../Babylon-Lite/packages/babylon-lite/src/material/node/esm-shadow-view.ts
  var esm_shadow_view_exports3 = {};
  __export(esm_shadow_view_exports3, {
    createNodeEsmShadowMaterialView: () => createNodeEsmShadowMaterialView
  });
  ...
  var NODE_ESM_SHADOW_DEPTH_CODE;
  var init_esm_shadow_view3 = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/material/node/esm-shadow-view.ts"() {
      "use strict";
      init_material_view();
      init_node_flags();
      NODE_ESM_SHADOW_DEPTH_CODE = `let depthMetricSM = (in.position.z + nmeShadowParams.depthValues.x) / nmeShadowParams.depthValues.y + nmeShadowParams.biasAndScale.x;
...
return vec4<f32>(depthSM, 1.0, 1.0, 1.0);`;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/shadow/esm-directional-shadow-generator.ts
  init_typed_arrays();
  init_gpu_flags();
  init_gpu_buffers();
  init_samplers();
  ...
  // vite-raw:E:\dev\babylon\DawnTest\Babylon-Lite\packages\babylon-lite\shaders\shadow-blur.vertex.wgsl
  var shadow_blur_vertex_default = "// Shadow Blur Vertex Shader \u2014 fullscreen quad with pre-computed sample coordinates\r\n// Uses Babylon's kernel blur approach with bilinear tap offsets\r\n\r\nstruct BlurParams {\r\n  delta: vec2<f32>,   // (1/texWidth, 0) for H pass, (0, 1/texHeight) for V pass\r\n  _pad: vec2<f32>,\r\n};\r\n@group(0) @binding(0) var<uniform> params: BlurParams;\r\n\r\nstruct VertexOutput {\r\n  @builtin(position) clipPos: vec4<f32>,\r\n  @location(0) sampleCenter: vec2<f32>,\r\n};\r\n\r\n@vertex\r\nfn main(@builtin(vertex_index) vertexIndex: u32) -> VertexOutput {\r\n  // Fullscreen triangle (3 vertices cover the screen)\r\n  var pos = array<vec2<f32>, 3>(\r\n    vec2<f32>(-1.0, -1.0),\r\n    vec2<f32>(3.0, -1.0),\r\n    vec2<f32>(-1.0, 3.0),\r\n  );\r\n\r\n  var out: VertexOutput;\r\n  let p = pos[vertexIndex];\r\n  out.clipPos = vec4<f32>(p, 0.0, 1.0);\r\n  out.sampleCenter = p * vec2<f32>(0.5, -0.5) + 0.5;\r\n  return out;\r\n}\r\n";

  // ../../../Babylon-Lite/packages/babylon-lite/src/shadow/esm-directional-shadow-generator.ts
  init_pack_mat4_into_f32();
  var esmShadowTaskResources = null;
  var createStandardEsmShadowMaterialView2;
  var createPbrEsmShadowMaterialView2;
  var createNodeEsmShadowMaterialView2;
  function getEsmShadowTaskResourceMap() {
    esmShadowTaskResources ?? (esmShadowTaskResources = /* @__PURE__ */ new WeakMap());
  ...
  async function preloadEsmShadowTaskState(casterMeshes) {
    ...
    if (needsStandard && !createStandardEsmShadowMaterialView2) {
      loads.push(
        Promise.resolve().then(() => (init_esm_shadow_view(), esm_shadow_view_exports)).then((module) => {
          createStandardEsmShadowMaterialView2 = module.createStandardEsmShadowMaterialView;
        })
      );
    }
    if (needsPbr && !createPbrEsmShadowMaterialView2) {
      loads.push(
        Promise.resolve().then(() => (init_esm_shadow_view2(), esm_shadow_view_exports2)).then((module) => {
          createPbrEsmShadowMaterialView2 = module.createPbrEsmShadowMaterialView;
        })
      );
    }
    if (needsNode && !createNodeEsmShadowMaterialView2) {
      loads.push(
        Promise.resolve().then(() => (init_esm_shadow_view3(), esm_shadow_view_exports3)).then((module) => {
          createNodeEsmShadowMaterialView2 = module.createNodeEsmShadowMaterialView;
        })
      );
    }
    await Promise.all(loads);
  ...
  function renderEsmShadowMap(engine, sg, state) {
    ...
    const matrix = _computeDirectionalLightMatrix(sg._light, casterMeshes, sg._config._orthoMinZ, sg._config._orthoMaxZ, offX, offY, offZ);
  ...
  function getEsmShadowView(material, cache, shadowParamsUBO) {
    ...
    let view;
    if (family === "standard") {
      view = createStandardEsmShadowMaterialView2(material, shadowParamsUBO);
    } else if (family === "pbr") {
      view = createPbrEsmShadowMaterialView2(material, shadowParamsUBO);
    } else if (family === "node") {
      view = createNodeEsmShadowMaterialView2(material, shadowParamsUBO);
    }
  ...
  function createEsmDirectionalShadowGenerator(engine, _light, cfg = {}) {
    ...
    const blurVert = device.createShaderModule({ code: shadow_blur_vertex_default });
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/shadow/pcf-spotlight-shadow-generator.ts
  init_typed_arrays();
  init_gpu_flags();
  ...
  function renderPcfShadowMap(engine, sg, state, computeLightMatrix) {
    ...
    updateShadowCamera2(state, sg, matrix);
    state._lastCasterVersion = casterVersion;
    state._lastLightVersion = lightVersion;
    state._lastFoVersion = foVersion;
    return state._task.execute?.() ?? 0;
  }
  function updateShadowCamera2(state, sg, matrix) {
    state._cameraVersion++;
  ...
  init_typed_arrays();
  init_gpu_flags();
  function _computeDirectionalLightMatrix2(light, casterMeshes, orthoMinZ, orthoMaxZ, offX = 0, offY = 0, offZ = 0) {
    const view = buildLightViewMatrix(light.direction.x, light.direction.y, light.direction.z, light.position.x - offX, light.position.y - offY, light.position.z - offZ);
  ...
  function createPcfDirectionalShadowGenerator(engine, _light, cfg = {}) {
    ...
    sg._renderShadowMap = (engine2, state) => {
      return renderPcfShadowMap(
        ...
        sg,
        state,
        (casterMeshes, offX, offY, offZ) => _computeDirectionalLightMatrix2(_light, casterMeshes, orthoMinZ, orthoMaxZ, offX, offY, offZ)
      );
    };
    return sg;
  }
  ...
  // ../../../Babylon-Lite/lab/lite/src/shared/scene63-nme.ts
  var SCENE63_NME_JSON = {
    tags: null,
    ignoreAlpha: false,
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene111.ts
  var STD_ID = "scene111-standard-sphere";
  var PBR_ID = "scene111-pbr-sphere";
  var NME_ID = "scene111-node-sphere";
  var STD_PLANE_ID = "scene111-standard-plane";
  var PBR_PLANE_ID = "scene111-pbr-plane";
  var NME_PLANE_ID = "scene111-node-plane";
  var RECEIVER_PLANE_SIZE = { width: 2.8, height: 4.8, subdivisions: 2 };
