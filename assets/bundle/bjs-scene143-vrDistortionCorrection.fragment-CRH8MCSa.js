import{S as e}from"./bjs-scene143.js";const r="vrDistortionCorrectionPixelShader",t=`#define DISABLE_UNIFORMITY_ANALYSIS
...
else{fragmentOutputs.color=textureSample(textureSampler,textureSamplerSampler,tc);}}`;e.ShadersStoreWGSL[r]||(e.ShadersStoreWGSL[r]=t);const n={name:r,shader:t};export{n as vrDistortionCorrectionPixelShaderWGSL};