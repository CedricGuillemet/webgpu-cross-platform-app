...
return out;
  ...
  // ../../../Babylon-Lite/lab/lite/src/_shared/scroll-tile-image.ts
  var SCROLL_TILE_SIZE = 64;
  var SCENE96_COLS = 20;
  var SCENE96_ROWS = 9;
  var SCENE96_BAND_OFFSETS = [
    [0, 0],
    [0.5, 0],
    [0, 0.5]
  ];
  function scene96BandForRow(row) {
    return Math.floor(row / 3);
  }
  var _baseCanvas = null;
  var _baseUrl = null;
  function drawBaseTile(ctx) {
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene96.ts
  async function main() {
