...
${varyBody}
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/physics/havok-trigger.ts
  init_havok();
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene101.ts
  var PHYSICS_FPS = 60;
  ...
  async function main() {
    ...
    createPhysicsAggregate(world, sphere, 0 /* SPHERE */, { mass: 1 });
    createPhysicsAggregate(world, ground, 3 /* BOX */, { mass: 0, restitution: 1 });
    const triggerShape = createPhysicsShape(world, { type: 0 /* SPHERE */, parameters: { center: { x: 0, y: 0, z: 0 }, radius: 2 } });
    setPhysicsShapeIsTrigger(world, triggerShape, true);
    const triggerNode = createTransformNode("trigger", 0, 0, 0);
    const triggerBody = createPhysicsBody(world, triggerNode, 0 /* STATIC */);
