import{S as e}from"./bjs-scene174.js";const t="decalFragmentDeclaration",f=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=f);const o="prePassDeclaration",p=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=p);const r="oitDeclaration",u=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=u);const i="lightFragmentDeclaration",m=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=m);const a="lightUboDeclaration",S=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=g);const l="shadowsFragmentFunctions",D=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=D);const c="imageProcessingDeclaration",w=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=w);const n="imageProcessingFunctions",E=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=E);const v="depthPrePass",C=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=C);const d="logDepthFragment",x=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=x);const h="oitFragment",T=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=T);