...
${varyBody}
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/math/mat4-from-quat.ts
  function mat4FromQuat(qx, qy, qz, qw) {
    const out = new F32(16);
    mat4ComposeInto(out, 0, 0, 0, 0, qx, qy, qz, qw, 1, 1, 1);
    return out;
  }
  var init_mat4_from_quat = __esm({
    "../../../Babylon-Lite/packages/babylon-lite/src/math/mat4-from-quat.ts"() {
      "use strict";
      init_typed_arrays();
      init_mat4_compose_into();
...
`
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/gizmo/bounding-box-gizmo.ts
  init_scene_core();
  init_compute_aabb();
  init_mat4_from_quat();
  init_mat4_multiply();
  ...
  function applyRotation(node, ax, ay, az, angle) {
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene224.ts
  async function main() {
