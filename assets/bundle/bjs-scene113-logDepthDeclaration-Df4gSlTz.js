import{S as e}from"./bjs-scene113.js";const o="sceneUboDeclaration",n=`layout(std140,column_major) uniform;uniform Scene {mat4 viewProjection;
#ifdef MULTIVIEW
mat4 viewProjectionR;
#endif 
mat4 view;mat4 projection;vec4 vEyePosition;mat4 inverseProjection;};
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=n);const t="meshUboDeclaration",c=`#ifdef WEBGL2
...
#endif
#define WORLD_UBO
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=c);const i="defaultUboDeclaration",s=`layout(std140,column_major) uniform;uniform Material
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=s);const a="mainUVVaryingDeclaration",f=`#ifdef MAINUV{X}
varying vec2 vMainUV{X};
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=f);const r="logDepthDeclaration",v=`#ifdef LOGARITHMICDEPTH
