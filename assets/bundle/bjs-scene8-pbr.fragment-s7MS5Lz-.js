import{S as e}from"./bjs-scene8.js";import"./bjs-scene8-logDepthDeclaration-z4Te_RXW.js";import"./bjs-scene8-fogFragment-CxxTav1S.js";import"./bjs-scene8-helperFunctions-zobtCVHj.js";import"./bjs-scene8-hdrFilteringFunctions-YYMTKB0E.js";import"./bjs-scene8-pbrBRDFFunctions-Dx9OYMPX.js";const t="prePassDeclaration",ae=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=ae);const o="oitDeclaration",ne=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=fe);const r="pbrFragmentExtraDeclaration",le=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=le);const f="lightFragmentDeclaration",ce=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=ce);const l="lightUboDeclaration",se=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=se);const c="samplerFragmentDeclaration",de=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=de);const s="samplerFragmentAlternateDeclaration",ue=`#ifdef _DEFINENAME_
#if _DEFINENAME_DIRECTUV==1
#define v_VARYINGNAME_UV vMainUV1
#elif _DEFINENAME_DIRECTUV==2
#define v_VARYINGNAME_UV vMainUV2
...
#endif
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=ue);const d="pbrFragmentReflectionDeclaration",Ee=`#ifdef REFLECTION
...
#endif
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=Ee);const u="pbrFragmentSamplersDeclaration",ve=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=ve);const E="imageProcessingDeclaration",he=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=he);const v="subSurfaceScatteringFunctions",me=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=me);const h="pbrHelperFunctions",Se=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=Se);const m="imageProcessingFunctions",pe=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=pe);const S="shadowsFragmentFunctions",Ce=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=Re);const C="pbrDirectLightingSetupFunctions",ge=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=ge);const R="pbrDirectLightingFalloffFunctions",Ae=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=Ae);const g="pbrDirectLightingFunctions",Ie=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=Ie);const A="pbrIBLFunctions",Te=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=Te);const I="bumpFragmentMainFunctions",Le=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=Le);const T="bumpFragmentFunctions",De=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=De);const L="reflectionFunction",Ne=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=Ne);const D="decalFragment",Oe=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=Oe);const N="pbrBlockAlbedoOpacity",Me=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=Me);const O="pbrBlockReflectivity",_e=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=_e);const M="pbrBlockAmbientOcclusion",Fe=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[M]||(e.IncludesShadersStore[M]=Fe);const _="pbrBlockAlphaFresnel",Pe=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=Pe);const F="pbrBlockAnisotropic",Ue=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=Ue);const P="pbrBlockReflection",be=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=be);const U="pbrBlockSheen",xe=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=xe);const b="pbrBlockClearcoat",ye=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=ye);const x="pbrBlockIridescence",we=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=we);const y="pbrBlockSubSurface",Xe=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=Xe);const w="clusteredLightingFunctions",Be=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=Be);const X="pbrBlockReflectance0",Ge=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=Ge);const B="pbrClusteredLightingFunctions",He=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=He);const G="pbrBlockNormalGeometric",Ve=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=Ve);const H="bumpFragment",We=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=We);const V="pbrBlockNormalFinal",ze=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=ze);const W="depthPrePass",ke=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=ke);const z="pbrBlockLightmapInit",Ye=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=Ye);const k="pbrBlockGeometryInfo",$e=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=$e);const Y="pbrBlockReflectance",Ke=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=Ke);const $="pbrBlockDirectLighting",qe=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[$]||(e.IncludesShadersStore[$]=qe);const K="lightFragment",Ze=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=Ze);const q="pbrBlockFinalLitComponents",je=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[q]||(e.IncludesShadersStore[q]=je);const Z="pbrBlockFinalUnlitComponents",Qe=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[Z]||(e.IncludesShadersStore[Z]=Qe);const j="pbrBlockFinalColorComposition",Je=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=Je);const Q="logDepthFragment",ei=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[Q]||(e.IncludesShadersStore[Q]=ei);const J="pbrBlockImageProcessing",ii=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=ii);const ee="pbrBlockPrePass",ti=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[ee]||(e.IncludesShadersStore[ee]=ti);const ie="oitFragment",oi=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[ie]||(e.IncludesShadersStore[ie]=oi);const te="pbrDebug",ai=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[te]||(e.IncludesShadersStore[te]=ai);const i="pbrPixelShader",oe=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[i]||(e.ShadersStore[i]=oe);const di={name:i,shader:oe};export{di as pbrPixelShader};