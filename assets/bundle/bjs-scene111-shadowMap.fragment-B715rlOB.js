import{S as e}from"./bjs-scene111.js";const r="bayerDitherFunctions",t=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=t);const i="shadowMapFragmentExtraDeclaration",f=`#if SM_FLOAT==0
...
varying zSM: f32;
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=f);const a="shadowMapPixelShader",n=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
}`;e.ShadersStoreWGSL[a]||(e.ShadersStoreWGSL[a]=n);const S={name:a,shader:n};export{S as shadowMapPixelShaderWGSL};