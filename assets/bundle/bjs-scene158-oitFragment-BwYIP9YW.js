import{S as e}from"./bjs-scene158.js";const t="decalFragmentDeclaration",u=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=u);const o="prePassDeclaration",m=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=m);const a="oitDeclaration",S=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=w);const l="shadowsFragmentFunctions",E=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=E);const c="imageProcessingDeclaration",C=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=C);const n="imageProcessingFunctions",x=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=x);const v="fogFragmentDeclaration",T=`#ifdef FOG
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=T);const d="depthPrePass",F=`#ifdef DEPTHPREPASS
