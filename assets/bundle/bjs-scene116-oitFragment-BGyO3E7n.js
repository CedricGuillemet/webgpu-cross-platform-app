import{S as e}from"./bjs-scene116.js";const t="prePassDeclaration",C=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=C);const i="oitDeclaration",L=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=L);const o="decalFragmentDeclaration",E=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=E);const a="lightFragmentDeclaration",T=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=T);const r="lightUboDeclaration",x=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=X);const n="imageProcessingDeclaration",I=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=I);const l="imageProcessingFunctions",A=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=A);const d="shadowsFragmentFunctions",P=`#ifdef SHADOWS
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=F);const c="bumpFragmentMainFunctions",M=`#if defined(BUMP) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=M);const h="bumpFragmentFunctions",y=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=y);const v="reflectionFunction",N=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=N);const u="decalFragment",O=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=O);const p="clusteredLightingFunctions",R=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=R);const m="bumpFragment",b=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=b);const S="depthPrePass",U=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=U);const g="lightFragment",_=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=_);const w="logDepthFragment",z=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=z);const D="oitFragment",H=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
