...
return out;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/sprite/sprite-2d-handle.ts
  init_typed_arrays();
  var MAX_HANDLE_ID = 4294967295;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/sprite/sprite-animation.ts
  var spriteAnimationOwners;
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/sprite/sprite-2d-handle-animation.ts
  function playSprite2DAnimation(manager, handle, from, to, loop, delayMs, options) {
  ...
  // ../../../Babylon-Lite/packages/babylon-lite/src/sprite/sprite-renderer.ts
  init_typed_arrays();
  init_gpu_flags();
  init_engine();
  init_gpu_buffers();
  init_sprite_fx_hook();
  var KIND = "sprite-renderer";
  ...
  var _scratchUbo = new F32(LAYER_UBO_BYTES / 4);
  ...
  // ../../../Babylon-Lite/lab/lite/src/_shared/player-sprite.ts
  var PLAYER_SPRITE_URL = "/textures/sprites/player.png";
  var PLAYER_SPRITE_INFO = {
    textureWidthPx: 1408,
    textureHeightPx: 192,
    frameWidthPx: 64,
    frameHeightPx: 64,
  ...
  var PLAYER_SPRITE_SEEK_STEP_MS = 1e3 / 60;
  function getPlayerSpriteSeekStepCount(seekTimeSeconds) {
  ...
  // ../../../Babylon-Lite/lab/lite/src/_shared/player-lite-sprite.ts
  function seekSpriteAnimationManager(manager, seekTimeSeconds) {
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene58.ts
  async function main() {
