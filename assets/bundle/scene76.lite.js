...
${wrapper.options.fragmentWGSL}`
  ...
  function prepareEffectRenderer(er) {
    er._pipeline ?? (er._pipeline = getEffectPipeline(er._effect, er._targetSignature));
  ...
  // ../../../Babylon-Lite/lab/lite/src/lite/scene76.ts
  var FRAGMENT_WGSL = `@group(0) @binding(0) var inputTexture:texture_2d<f32>;
