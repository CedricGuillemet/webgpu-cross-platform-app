import{S as r}from"./bjs-scene143.js";import"./bjs-scene143-hdrFilteringFunctions-D7WK_LCS.js";import"./bjs-scene143-pbrBRDFFunctions-CknhoMGW.js";const e="iblDominantDirectionPixelShader",i=`#include<helperFunctions>
...
lightDir/=vec3f(f32(NUM_SAMPLES));fragmentOutputs.color=vec4f(lightDir,1.0);}`;r.ShadersStoreWGSL[e]||(r.ShadersStoreWGSL[e]=i);const l={name:e,shader:i};export{l as iblDominantDirectionPixelShaderWGSL};